...
/*
 Global variables
*/
$FAIRNESS_URL = 'https://demo.fairnesstna.com/next-release/api/json/api.php';
$FAIRNESS_USERNAME = 'demoadmin1';
$FAIRNESS_PASSWORD = 'demo';

//Build URL given a Class and Method to call.
//Format is: http://demo.fairnesstna.com/api/json/api.php?Class=<CLASS>&Method=<METHOD>&SessionID=<SessionID>
