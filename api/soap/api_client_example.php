<?php
require_once( '../../classes/modules/api/client/ClientAPI.class.php' );

/*
 Global variables
*/
$FAIRNESS_URL = 'https://demo.fairnesstna.com/next-release/api/soap/api.php';
$FAIRNESS_USERNAME = 'demoadmin1';
$FAIRNESS_PASSWORD = 'demo';
...
//
$new_hire_defaults_obj = new ClientAPI( 'UserDefault' );
...
//
$report_obj = new ClientAPI( 'TimesheetSummaryReport' );
