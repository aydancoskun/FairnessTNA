...
//							Debug::Text( '      Restarting FairnessTNA services... Exit Code: '. $exit_code, __FILE__, __LINE__, __METHOD__, 10 );
//							CLIExit(0);
//						} else {
...
//			}
	...
	if ( in_array('--schema_only', $argv) == FALSE AND in_array('--stage2', $argv) == FALSE ) {
		...
		if ( $full_force === TRUE OR Misc::isNewVersionReadyForUpgrade( $force ) === TRUE ) {
