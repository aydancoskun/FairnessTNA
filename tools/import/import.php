		...
		if ( $export_map == FALSE ) {
			...
			if ( is_array($column_map) ) {
				foreach( $column_map as $column_map_row ) {
					if ( isset($column_map_row['fairnesstna_column']) ) {
						$column_map_arr[$column_map_row['fairnesstna_column']] = array( 'map_column_name' => $column_map_row['csv_column'], 'default_value' => $column_map_row['default_value'], 'parse_hint' => $column_map_row['parse_hint'] );
