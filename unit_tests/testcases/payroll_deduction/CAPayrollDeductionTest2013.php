...
class CAPayrollDeductionTest2013 extends PHPUnit_Framework_TestCase
{
    ...
    public function testCA_2013a_Example()
    {
    ...
    public function testCA_2013a_Example1()
    {
    ...
    public function testCA_2013a_Example2()
    {
    ...
    public function testCA_2013a_Example3()
    {
    ...
    // CPP/ EI
    //
    public function testCA_2013a_BiWeekly_CPP_LowIncome()
    {
    ...
    public function testCA_2013a_SemiMonthly_CPP_LowIncome()
    {
        Debug::text('CA - BiWeekly - CPP - Beginning of 01-Jan-2013: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testCA_2013a_EI_LowIncome()
    {
    ...
    public function testCA_2013a_Example4()
    {
        Debug::text('CA - Example1 - Beginning of 01-Jan-2013: ', __FILE__, __LINE__, __METHOD__, 10);
