...
class USPayrollDeductionTest2009 extends PHPUnit_Framework_TestCase
{
    ...
    public function testUS_2009a_SocialSecurity()
    {
    ...
    public function testUS_2009a_SocialSecurity_Max()
    {
        Debug::text('US - SemiMonthly - Beginning of 2009 01-Jan-09: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2009a_Medicare()
    {
        Debug::text('US - SemiMonthly - Beginning of 2009 01-Jan-09: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2009a_FederalUI_NoState()
    {
        Debug::text('US - SemiMonthly - Beginning of 2009 01-Jan-09: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2009a_FederalUI_NoState_Max()
    {
        Debug::text('US - SemiMonthly - Beginning of 2009 01-Jan-09: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2009a_FederalUI_State_Max()
    {
        Debug::text('US - SemiMonthly - Beginning of 2009 01-Jan-09: ', __FILE__, __LINE__, __METHOD__, 10);
