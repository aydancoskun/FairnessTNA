...
class USPayrollDeductionTest2019 extends PHPUnit\Framework\TestCase {
	...
	public function setUp(): void {
		...
		$this->tax_table_file = dirname(__FILE__).'/USPayrollDeductionTest2019.csv';
		...
		foreach( $test_rows as $row ) {
			...
			if ( $row['country'] != '' AND $row['gross_income'] != '' ) {
				...
				if ( $row['provincial_deduction'] != '' ) {
					...
					if ( !in_array( $row['province'], array( 'CA', 'GA', 'NM', 'OR', 'LA', 'MO', 'VT' ) ) AND $amount_diff > 5 ) { //Some states had significant changes.
	...
	function testUS_ID_2019a_Test1() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1212.00' );
	...
	function testUS_LA_2019a_Test2() {
		//Example from employer guide.
		Debug::text('US - SemiMonthly - Beginning of 2019 01-Jan-2019: ', __FILE__, __LINE__, __METHOD__, 10);
	...
	function testUS_2019a_Test1() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '44.23' );
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '38.41' );
	...
	// US Social Security
	//
	function testUS_2019a_SocialSecurity() {
		Debug::text('US - SemiMonthly - Beginning of 2019 01-Jan-2019: ', __FILE__, __LINE__, __METHOD__, 10);
	...
	function testUS_2019a_SocialSecurity_Max() {
		Debug::text('US - SemiMonthly - Beginning of 2019 01-Jan-2019: ', __FILE__, __LINE__, __METHOD__, 10);
	...
	function testUS_2019a_Medicare() {
		Debug::text('US - SemiMonthly - Beginning of 2019 01-Jan-2019: ', __FILE__, __LINE__, __METHOD__, 10);
	...
	function testUS_2019a_Additional_MedicareA() {
		Debug::text('US - SemiMonthly - Beginning of 2019 01-Jan-2019: ', __FILE__, __LINE__, __METHOD__, 10);
	...
	function testUS_2019a_FederalUI_NoState_Max() {
		Debug::text('US - SemiMonthly - Beginning of 2019 01-Jan-2019: ', __FILE__, __LINE__, __METHOD__, 10);
	...
	function testUS_2019a_FederalUI_State_Max() {
		Debug::text('US - SemiMonthly - Beginning of 2019 01-Jan-2019: ', __FILE__, __LINE__, __METHOD__, 10);
