...
/**
 * @group USPayrollDeductionTest2016
 */
class USPayrollDeductionTest2016 extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->tax_table_file = dirname(__FILE__) . '/USPayrollDeductionTest2016.csv';
    ...
    public function testUS_2016a_Test1()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
        ...
        $this->assertEquals($this->mf($pd_obj->getFederalPayPeriodDeductions()), '55.72');
        $this->assertEquals($this->mf($pd_obj->getStatePayPeriodDeductions()), '37.87');
    ...
    // US Social Security
    //
    public function testUS_2016a_SocialSecurity()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_SocialSecurity_Max()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_Medicare()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_Additional_MedicareA()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_Additional_MedicareB()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_Additional_MedicareC()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_Additional_MedicareD()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_FederalUI_NoState()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_FederalUI_NoState_Max()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function testUS_2016a_FederalUI_State_Max()
    {
        Debug::text('US - SemiMonthly - Beginning of 2016 01-Jan-2016: ', __FILE__, __LINE__, __METHOD__, 10);
