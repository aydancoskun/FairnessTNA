...
class DependencyTreeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function indexOf($tofind, $arr)
    {
        foreach ($arr as $k => $v) {
            if ($tofind == $v) {
                return $k;
    ...
    public function testModerate_1()
    {
    ...
    public function testCircularDependency_1()
    {
    ...
    public function testTwoTrees_1()
    {
        $deptree = new DependencyTree();
    ...
    public function testTwoTrees_2()
    {
        $deptree = new DependencyTree();
