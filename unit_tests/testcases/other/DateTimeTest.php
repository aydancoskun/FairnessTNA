...
class DateTimeTest extends PHPUnit\Framework\TestCase {
	...
	function testTimeUnit4() {
		...
		*/
		...
		$this->assertEquals( TTDate::getTimeUnit( '' ), '0.0000' );
		$this->assertEquals( TTDate::getTimeUnit( '--' ), '0.0000' );
		$this->assertEquals( TTDate::getTimeUnit( 'XYZ' ), '0.0000' );
		$this->assertEquals( TTDate::getTimeUnit( NULL ), '0.0000' );
		$this->assertEquals( TTDate::getTimeUnit( FALSE ), '0.0000' );
		$this->assertEquals( TTDate::getTimeUnit( TRUE ), '0.0000' );
	}
