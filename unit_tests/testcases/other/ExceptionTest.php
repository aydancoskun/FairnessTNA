...
class ExceptionTest extends PHPUnit_Framework_TestCase
{
     ...
     */
    public function testExceptionMissingNormalIn()
    {
        global $dd;
    ...
    public function createExceptionPolicy($type)
    {
    ...
    public function calculateExceptions($date_epoch)
    {
    ...
    public function getExceptions($date_epoch)
    {
     ...
     */
    public function testExceptionMissingNormalOut()
    {
        global $dd;
     ...
     */
    public function testExceptionMissingNormalOutPreMature()
    {
        global $dd;
     ...
     */
    public function testExceptionMissingLunchInA()
    {
        global $dd;
     ...
     */
    public function testExceptionMissingLunchInB()
    {
        global $dd;
     ...
     */
    public function testExceptionMissingLunchInPreMature()
    {
        global $dd;
     ...
     */
    public function testExceptionMissingLunchOut()
    {
        global $dd;
    ...
    */
     ...
     */
    public function testExceptionMissingBreakInA()
    {
        global $dd;
     ...
     */
    public function testExceptionMissingBreakInB()
    {
        global $dd;
     ...
     */
    public function testExceptionMissingBreakInPreMature()
    {
        global $dd;
     ...
     */
    public function testExceptionMissingBreakOut()
    {
        global $dd;
     ...
     */
    public function testExceptionInLateA()
    {
        global $dd;
    ...
    public function checkCalcQuickExceptions($user_id, $start_date, $end_date, $check_date)
    {
     ...
     */
    public function testExceptionInLateA2()
    {
        global $dd;
     ...
     */
    public function testExceptionInLateB()
    {
        global $dd;
     ...
     */
    public function testExceptionInLateC()
    {
        global $dd;
     ...
     */
    public function testExceptionInLateD()
    {
        global $dd;
     ...
     */
    public function testExceptionOutLateA()
    {
        global $dd;
     ...
     */
    public function testExceptionOutLateB()
    {
        global $dd;
     ...
     */
    public function testExceptionOutLateC()
    {
        global $dd;
    ...
    public function deleteExceptions($date_epoch)
    {
        $elf = TTnew('ExceptionListFactory');
        $elf->getByCompanyIDAndUserIdAndStartDateAndEndDate($this->company_id, $this->user_id, $date_epoch, $date_epoch);
        if ($elf->getRecordCount() > 0) {
