...
class PayStubCalculationTest extends PHPUnit\Framework\TestCase {
	...
	function testMain() {
		...
		$this->assertEquals( $pse_arr[$pse_accounts['regular_time']][0]['amount'], '2408.0000' );
	...
	function testNoHoursPayStub() {
		...
		$this->assertEquals( $pse_arr[$pse_accounts['regular_time']][0]['rate'], '33.3300' );
		$this->assertEquals( $pse_arr[$pse_accounts['regular_time']][0]['units'], '3.0000' );
	...
	function testSalaryPayStubA() {
		...
		$this->assertEquals( $pse_arr[$pse_accounts['regular_time']][0]['amount'], '1000.0000' );
	...
	function testSalaryPayStubB() {
		...
		$this->assertEquals( $pse_arr[$pse_accounts['regular_time']][0]['units'], '48.0000' );
	...
	function testSalaryPayStubC() {
		...
		for( $i = 0; $i <= 12; $i++ ) {
			...
			$this->assertEquals( $pse_arr[$pse_accounts['regular_time']][$i]['amount'], '71.4300' );
