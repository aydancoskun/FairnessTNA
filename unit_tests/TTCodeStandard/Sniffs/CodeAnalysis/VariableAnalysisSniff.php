...
class TTCodeStandard_Sniffs_CodeAnalysis_VariableAnalysisSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function findVariableScope(
        PHP_CodeSniffer_File $phpcsFile,
        $stackPtr
    )
    {
    ...
    public function findFunctionPrototype(
        PHP_CodeSniffer_File $phpcsFile,
        $stackPtr
    )
    {
    ...
    public function findContainingBrackets(
        PHP_CodeSniffer_File $phpcsFile,
        $stackPtr
    )
    {
    ...
    public function markVariableReadAndWarnIfUndefined($phpcsFile, $varName, $stackPtr, $currScope)
    {
    ...
    public function isNextThingAnAssign(
        PHP_CodeSniffer_File $phpcsFile,
        $stackPtr
    )
    {
    ...
    public function findWhereAssignExecuted(
        PHP_CodeSniffer_File $phpcsFile,
        $stackPtr
    )
    {
    ...
    public function findFunctionCall(
        PHP_CodeSniffer_File $phpcsFile,
        $stackPtr
    )
    {
    ...
    public function findFunctionCallArguments(
        PHP_CodeSniffer_File $phpcsFile,
        $stackPtr
    )
    {
