var ApplicationRouter = Backbone.Router.extend( {
	...
	testInternetConnection: function() {
		...
		img.src = 'https://raw.githubusercontent.com/aydancoskun/FairnessTNA/master/interface/ping.gif?random-no-cache=' + Math.floor((1 + Math.random()) * 0x10000).toString(16);
	},
