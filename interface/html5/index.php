...
if ( getTTProductEdition() >= TT_PRODUCT_PROFESSIONAL ) {
	...
	header('Link: <framework/leaflet/leaflet-fairness.css?v='. APPLICATION_BUILD .'>; rel=preload; as=style', FALSE);
}
...
?><!DOCTYPE html>
	<html>
		<head>
			...
			<meta name="Description" content="Employee Login | FairnessTNA Workforce Management Software"/>
			...
			<?php } else { ?>
				...
				<?php if ( getTTProductEdition() >= TT_PRODUCT_PROFESSIONAL ) { ?>
                    ...
                    <link rel="stylesheet" type="text/css" href="framework/leaflet/leaflet-fairness.css?v=<?php echo APPLICATION_BUILD?>">
				<?php } ?>
    ...
    <div id="login-bg_animal">
        <div id="login-bg_opacity_filter">
			...
			if ( Misc::isSearchEngineBrowser() == TRUE ) { ?>
                <div class="site-description"><h1><a href="https://github.com/aydancoskun/FairnessTNA">FairnessTNA Time and Attendance Software</a></h1> <h3>Web-based Time And Attendance software which offers employee timeclock, timesheets and payroll all in single integrated package. With the ability to interface with biometric facial recognition tablets and smart phones employees are able to efficiently track their time at the office or in the field. Automatically calculate complex over time and premium time business policies and immediately be able to identify labor costs attributed to branches, and departments. FairnessTNA can process your payroll by calculating withholding taxes, generate electronic pay stubs and direct deposit funds.</h3></div>
			<?php } ?>
            ...
            <div id="bottomContainer" class="bottom-container">
                ...
                <div class="copyright-container">
                    <a id="copy_right_logo_link" class="copy-right-logo-link" target="_blank"><img id="copy_right_logo" class="copy-right-logo" style="display: none"></a>
                    <a id="copy_right_info" class="copy-right-info" target="_blank" style="display: none"></a>
                    <span id="copy_right_info_1" class="copy-right-info" style="display: none"><?php echo COPYRIGHT_NOTICE;?></span>
                </div>
                <?php
