				...
				switch ( $this.getWizardObject().selected_remittance_agency_event.type_id ) {
					...
					case 'T4SD':
						$this.addButton( ContextMenuIconName.payment_method,
							...
							$.i18n._( 'Make Payment' ),
							$.i18n._( 'Transmit payment with FairnessTNA Payment Services automatically.' )
						);
						break;
					case 'T4':
					case 'T4A':
						$this.addButton( ContextMenuIconName.e_file,
							Icons.e_file,
							$.i18n._( 'eFile' ),
							$.i18n._( 'Transmit forms to the CRA with FairnessTNA Payment Services automatically.' )
						);
						break;
					default:
						break;
