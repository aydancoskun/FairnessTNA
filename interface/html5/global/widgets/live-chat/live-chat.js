...
if ( current_company && current_user ) {
	...
	function openSupportChat() {
		(function() {
			...
			po.src = 'https://chat.fairnesstna.com/index.php/chat/getstatus/(click)/internal/(position)/api/(ma)/br/(dot)/true/(units)/pixels/(leaveamessage)/true/(department)/2/(disable_pro_active)/true?r=' + refferer + '&l=' + location + '&ttr=' + new Date().getTime();
