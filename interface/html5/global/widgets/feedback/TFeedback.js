( function ( $ ) {
	...
	$.fn.TFeedback = function ( _options ) {
		var options = $.extend( {
			...
			review_link: 'https://github.com/aydancoskun/FairnessTNA'
		}, _options );
		...
		function initDefaultPage() {
			...
			default_page.find( '.page-text' ).text( $.i18n._( 'Tell us what you think about FairnessTNA?' ) );
		...
		function initPositivePage() {
			...
			page_title.html( $.i18n._( 'Feedback' ) );
			positive_page.find( '.page-text.block1' ).text( $.i18n._( 'It thrills us to hear you think FairnessTNA is great!' ) );
