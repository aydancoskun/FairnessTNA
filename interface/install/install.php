...
if ( version_compare( PHP_VERSION, '5.4.0', '<') == 1 ) {
	echo "You are currently using PHP v<b>". PHP_VERSION ."</b> FairnessTNA requires PHP <b>v5.4</b> or greater!<br><br>\n";
	$redir = FALSE;
}
if ( version_compare( PHP_VERSION, '7.3.99', '>') == 1 ) {
	echo "You are currently using PHP v<b>". PHP_VERSION ."</b> FairnessTNA requires PHP <b>v7.3.x</b> or earlier!<br><br>\n";
	$redir = FALSE;
}

echo " 5...";
//if ( !is_writeable($templates_c_dir) ) {
//	echo "<b>". $templates_c_dir ."</b> is NOT writable by your web server!\n";
//	$redir = FALSE;
//}
...
//	echo "Your web server is unable to create directories inside of: <b>". $templates_c_dir ."</b>, please give your webserver write permissions to this directory.\n";
//	$redir = FALSE;
//}
//echo " 8...";
...
if ( $redir == TRUE ) {
	...
	echo " FAILED!<br><br>\n";
	echo "For installation support, please join our community or open a ticket at https://github.com/aydancoskun/FairnessTNA\" target=\"_blank\">Implementation Support Services</a>.
		<br>\n";
}
echo "</body></html>";
?>
