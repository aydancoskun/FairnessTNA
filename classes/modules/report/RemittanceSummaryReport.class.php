...
class RemittanceSummaryReport extends Report {
	...
	/**
	 * Formats report data for exporting to FairnessTNA payment service.
	 * @param $prae_obj
	 * @param $pra_obj
	 * @param $rs_obj
	 * @param $pra_user_obj
...
//
//				$this->pdf->writeHTMLcell( 100, 5, ( ( $this->pdf->getPageWidth() - 100 ) / 2 ), $this->pdf->getY(), '<a href="https://github.com/aydancoskun/FairnessTNA">PAY ONLINE NOW</>', 1, 0, FALSE, TRUE, 'C');
//
//				$this->pdf->SetFont($this->config['other']['default_font'], '', $this->_pdf_fontSize( $this->config['other']['table_row_font_size'] ) );
//				$this->pdf->SetTextColor(0);
//				$this->pdf->SetDrawColor(0);
...
//			$summary_table_data['end_remitting_period'] = ( $transaction_date > 0 ) ? date('Y-m', $transaction_date) : TTi18n::getText("N/A");
			...
			//$this->html .= '<tr><th class="pay-online" colspan="' . count($columns) . '"><a href="https://github.com/aydancoskun/FairnessTNA" target="_blank">PAY ONLINE NOW</a></th></tr>';
