...
//				} else
	...
	/**
	 * @return false always. We keep this function in here as mobile apps might call this
	 */
	...
	function getPreLoginData( $api = NULL ) {
		...
		$retarr = array(
				...
				'support_email' => ( isset($config_vars['other']['support_email']) AND $config_vars['other']['support_email'] != '' ) ? $config_vars['other']['support_email'] : 'support@fairnesstna.com',
				...
				'map_provider' => isset($config_vars['map']['provider'] ) ? $config_vars['map']['provider'] : 'google',

				//registration key for the map servers must be added in JS because of the url formats
				'map_tile_url' => isset( $config_vars['map']['tile_url'] ) ? rtrim($config_vars['map']['tile_url'], '/') : '//map-tiles.google.com',
				'map_routing_url' => isset( $config_vars['map']['routing_url'] ) ? rtrim($config_vars['map']['routing_url'], '/') : '//map-routing.google.com',
				'map_geocode_url' => isset( $config_vars['map']['geocode_url'] ) ? rtrim($config_vars['map']['geocode_url'], '/') : '//map-geocode.google.com',
