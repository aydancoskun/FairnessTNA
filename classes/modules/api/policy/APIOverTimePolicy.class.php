...
class APIOverTimePolicy extends APIFactory {
	...
	function getOverTimePolicy( $data = NULL, $disable_paging = FALSE ) {
		...
		$blf = TTnew( 'OverTimePolicyListFactory' ); /** @var OverTimePolicyListFactory $blf */
	 ...
	 * @return array|bool
	 */
	function setOverTimePolicy( $data, $validate_only = FALSE, $ignore_warning = TRUE ) {
