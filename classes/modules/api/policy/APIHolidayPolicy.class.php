...
class APIHolidayPolicy extends APIFactory {
	...
	function getHolidayPolicy( $data = NULL, $disable_paging = FALSE ) {
		...
		$blf = TTnew( 'HolidayPolicyListFactory' ); /** @var HolidayPolicyListFactory $blf */
	 ...
	 * @return array|bool
	 */
	function exportHolidayPolicy( $format = 'csv', $data = NULL, $disable_paging = TRUE ) {
	 ...
	 * @return array|bool
	 */
	function setHolidayPolicy( $data, $validate_only = FALSE, $ignore_warning = TRUE ) {
