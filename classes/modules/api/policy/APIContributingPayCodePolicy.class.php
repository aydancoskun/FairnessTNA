...
class APIContributingPayCodePolicy extends APIFactory {
	...
	/**
	 * APIContributingPayCodePolicy constructor.
	 */
	 ...
	 * @return array
	 */
	function getContributingPayCodePolicyDefaultData() {
	 ...
	 * @return array
	 */
	function getContributingPayCodePolicy( $data = NULL, $disable_paging = FALSE ) {
		...
		$blf = TTnew( 'ContributingPayCodePolicyListFactory' ); /** @var ContributingPayCodePolicyListFactory $blf */
	 ...
	 * @return array|bool
	 */
	function exportContributingPayCodePolicy( $format = 'csv', $data = NULL, $disable_paging = TRUE) {
	 ...
	 * @return array
	 */
	function getCommonContributingPayCodePolicyData( $data ) {
	 ...
	 * @return array
	 */
	function validateContributingPayCodePolicy( $data ) {
	 ...
	 * @return array|bool
	 */
	function setContributingPayCodePolicy( $data, $validate_only = FALSE, $ignore_warning = TRUE ) {
	 ...
	 * @return array|bool
	 */
	function deleteContributingPayCodePolicy( $data ) {
		if ( !is_array($data) ) {
			$data = array($data);
		}
	 ...
	 * @return array
	 */
	function copyContributingPayCodePolicy( $data ) {
		if ( !is_array($data) ) {
			$data = array($data);
		}
