...
class APIBreakPolicy extends APIFactory {
	...
	function getBreakPolicy( $data = NULL, $disable_paging = FALSE ) {
		...
		$blf = TTnew( 'BreakPolicyListFactory' ); /** @var BreakPolicyListFactory $blf */
	 ...
	 * @return array|bool
	 */
	function exportBreakPolicy( $format = 'csv', $data = NULL, $disable_paging = TRUE ) {
	 ...
	 * @return array|bool
	 */
	function setBreakPolicy( $data, $validate_only = FALSE, $ignore_warning = TRUE ) {
