...
class APISchedulePolicy extends APIFactory {
	...
	function getSchedulePolicyDefaultData() {
		...
		$data = array(
						...
						'meal_policy_id' => TTUUID::getZeroID(), //Defined by policy group. Needs to be a string otherwise Flex ignores it.
						'break_policy_id' => TTUUID::getZeroID(), //Defined by policy group. Needs to be a string otherwise Flex ignores it.
	 ...
	 * @return array|bool
	 */
	function setSchedulePolicy( $data, $validate_only = FALSE, $ignore_warning = TRUE ) {
