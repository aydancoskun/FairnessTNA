...
class APIRecurringHoliday extends APIFactory {
	...
	/**
	 * APIRecurringHoliday constructor.
	 */
	...
	function getRecurringHoliday( $data = NULL, $disable_paging = FALSE ) {
		...
		$blf = TTnew( 'RecurringHolidayListFactory' ); /** @var RecurringHolidayListFactory $blf */
	 ...
	 * @return array|bool
	 */
	function exportRecurringHoliday( $format = 'csv', $data = NULL, $disable_paging = TRUE ) {
	 ...
	 * @return array|bool
	 */
	function setRecurringHoliday( $data, $validate_only = FALSE, $ignore_warning = TRUE ) {
