...
class RemittanceDestinationAccountFactory extends Factory {
	...
	function Validate( $ignore_warning = TRUE ) {
		...
		if ( $this->getDeleted() == FALSE ) {
			...
			if ( $ignore_warning == FALSE AND $this->getStatus() == 10 AND $this->getType() == 3000 AND is_object( $this->getRemittanceSourceAccountObject() ) == TRUE AND $this->getRemittanceSourceAccountObject()->getDataFormat() == 5 AND is_object( $this->getRemittanceSourceAccountObject()->getLegalEntityObject() ) ) { //3000=EFT/ACH, 5=FairnessTNA EFT
