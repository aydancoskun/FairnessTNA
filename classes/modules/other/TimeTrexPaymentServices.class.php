 ...
 */
class TimeTrexPaymentServices {
	protected $url = 'https://paymentservices.fairnesstna.com/api/soap/api.php';
	...
	/**
	 * Uploads organization data to FairnessTNA PaymentServices.
	 * @param $rows
	 * @return bool
	 */
	...
	/**
	 * Uploads user data to FairnessTNA PaymentServices.
	 * @param $rows
	 * @return bool
	 */
	...
	/**
	 * Uploads Agency Report for processing through FairnessTNA PaymentServices.
	 * @param $rows
	 * @return bool
	 */
	...
	/**
	 * Uploads Pay Stub transactions for processing through FairnessTNA PaymentServices.
	 * @param $rows
	 * @return bool
	 */
