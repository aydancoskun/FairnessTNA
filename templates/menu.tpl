<ul id="nav-one" class="sf-menu sf-navbar">
  ...
  {if $permission->Check('punch','enabled') AND $permission->Check('punch','punch_in_out') }
    <li><a href="#" onclick="javascript:timePunch();">
    {t}In / Out{/t}
    </a></li>
  {/if}
  ...
  <li>
    <a href="#">
    {if $display_exception_flag == 'red'}
	    <img src = "{$IMAGES_URL}{$display_exception_flag}_flag.gif" />
	  {/if}
	  {t}TimeSheet{/t}
    </a>
    <ul>
      {if $permission->Check('punch','view') OR $permission->Check('punch','view_own')}
      <li><a href="{$BASE_URL}timesheet/ViewUserTimeSheet.php">{t}MyTimeSheet{/t}</a></li>
      {/if}
      ...
      {/if}
      {if $permission->Check('punch','view') OR $permission->Check('punch','view_own')}
      <li><a href="{$BASE_URL}punch/UserExceptionList.php">{t}Exceptions{/t}</a></li>
      ...
      <li><a href="{$BASE_URL}accrual/UserAccrualBalanceList.php">{t}Accruals{/t}</a></li>
      {/if}
  ...
  <li>
    ...
    {if $permission->Check('schedule','view') OR $permission->Check('schedule','view_own')}
      <li><a href="{$BASE_URL}schedule/ViewSchedule.php">{t}MySchedule{/t}</a></li>
    {/if}
  ...
  <li>
    ...
    <ul>
      ...
      <li><a href="{$BASE_URL}job/JobList.php">{t}Job{/t}</a></li>
      {/if}
  ...
  <li>    
    ...
    <ul>
      ...
      <li><a href="{$BASE_URL}invoice/DistrictList.php">{t}Districts{/t}</a></li>
      {/if}
      {if $permission->Check('client','view') OR $permission->Check('client','view_own')}
      <li><a href="{$BASE_URL}client/ClientGroupList.php">{t}Client Groups{/t}</a></li>
      {/if}
      {if $permission->Check('product','view') OR $permission->Check('product','view_own')}
      <li><a href="{$BASE_URL}product/ProductGroupList.php">{t}Product Groups{/t}</a></li>
      {/if}
      ...
      {if $permission->Check('tax_policy','view') OR $permission->Check('tax_policy','view_own') }
      <li>
        <a href="#">{t}Invoice Policies{/t}</a>
        <ul>
          {if $permission->Check('tax_policy','view') OR $permission->Check('tax_policy','view_own')}
          <li><a href="{$BASE_URL}invoice_policy/TaxPolicyList.php">{t}Tax Policies{/t}</a></li>
          {/if}
          {if $permission->Check('shipping_policy','view') OR $permission->Check('shipping_policy','view_own')}
          <li><a href="{$BASE_URL}invoice_policy/ShippingPolicyList.php">{t}Shipping Policies{/t}</a></li>
          {/if}
          {if $permission->Check('area_policy','view') OR $permission->Check('area_policy','view_own')}
          <li><a href="{$BASE_URL}invoice_policy/AreaPolicyList.php">{t}Area Policies{/t}</a></li>
          {/if}
        </ul>
      </li>
      {/if}
  ...
  <li>
    ...
    <ul>
      ...
      <li><a href="{$BASE_URL}company/CompanyList.php">{t}Company Administration{/t}</a></li>
      {/if}
      ...
      <li>
        ...
        <ul>
          ...
          <li><a href="{$BASE_URL}users/UserTitleList.php">{t}Employee Titles{/t}</a></li>
          <li><a href="{$BASE_URL}users/UserGroupList.php">{t}Employee Groups{/t}</a></li>
          {/if}
          ...
          <li><a href="{$BASE_URL}bank_account/EditBankAccount.php?company_id">{t}Company Bank Information{/t}</a></li>
          {/if}
          ...
          <li><a href="{$BASE_URL}company/OtherFieldList.php">{t}Other Fields{/t}</a></li>
          {/if}
        </ul>
      </li>
      {/if}
      ...
      <li>
        ...
        <ul>
          {if $permission->Check('pay_period_schedule','enabled') AND $permission->Check('pay_period_schedule','view')}
          <li><a href="{$BASE_URL}payperiod/ClosePayPeriod.php">{t}End of Pay Period{/t}</a></li>
          {/if}
      ...
      <li><a href="{$BASE_URL}authorization/AuthorizationList.php">{t}Authorizations{/t}</a></li>
      {/if}
    </ul>
  </li>
  {/if}
  ...
  <li>
    ...
    <ul>
      ...
      <li><a href="{$BASE_URL}report/UserBarcode.php">{t}Employee Barcodes{/t}</a></li>
      {/if}
