...
if ( version_compare( PHP_VERSION, '5.3.0', '<') == 1 ) {
	echo "You are currently using PHP v<b>". PHP_VERSION ."</b> Fairness requires PHP <b>v5.3</b> or greater!<br><br>\n";
	$redir = FALSE;
}
if ( version_compare( PHP_VERSION, '7.0.99', '>') == 1 ) {
	echo "You are currently using PHP v<b>". PHP_VERSION ."</b> Fairness requires PHP <b>v7.0.x</b> or earlier!<br><br>\n";
	$redir = FALSE;
}
...
//	echo "PHP INTL extension is not installed, Fairness requires INTL to be installed.<br><br>\n";
//	$redir = FALSE;
//}
if ( extension_loaded( 'gettext' ) == FALSE ) {
	echo "PHP GetText extension is not installed, Fairness requires GetText to be installed.<br><br>\n";
	$redir = FALSE;
}
if ( extension_loaded( 'mbstring' ) == FALSE ) {
	echo "PHP MBSTRING extension is not installed, Fairness requires MBSTRING to be installed.<br><br>\n";
	$redir = FALSE;
}
if ( extension_loaded( 'json' ) == FALSE ) {
	echo "PHP JSON extension is not installed, Fairness requires JSON to be installed.<br><br>\n";
	$redir = FALSE;
}
...
if ( $redir == TRUE ) {
	...
	echo " FAILED!<br><br>\n";
	echo "For installation support, please join our community. <a href=\"https://github.com/aydancoskun/fairness" target=\"_blank\"></a>
		<br>\n";
}
echo "</body></html>";
?>
