		...
		switch ( this.current_step ) {
			case 'license':
				...
				if ( stepData['install_mode'] ) {
					...
					var license_html = $.i18n._( 'The installer has already been run, as a safety measure it has been disabled from running again. If you are absolutely sure you want to run it again, or upgrade your system, please go to your fairness.ini.php file and set "installer_enabled" to "TRUE". The line should look like' ) + ':';
			...
			case 'requirements':
				...
				if ( stepData.check_all_requirements != 0 ) {
						...
						+ $.i18n._( 'For installation support, please visit ' )
						+ '<a href="https://github.com/aydancoskun/fairness" target="_blank"></a></p>';
				}
				...
				if ( stepData.check_all_requirements == 0 ) {
					...
					this.addEditFieldToColumn( $.i18n._( 'Writable' ) + ' ' + $.i18n._( stepData.application_name ) + ' ' + $.i18n._( 'Configuration File' ) + "<br>" + "(fairness.ini.php)", form_item_input, requirements_column2, '', null, true, true );
				...
				columns_html = columns_html + '(fairness.ini.php)';
					...
					switch ( key ) {
						...
						case 'base_url':
							if ( stepData[key].check_base_url == 0 ) {
								...
								widget.html( key + ' ' + $.i18n._( 'in' ) + ' fairness.ini.php' + $.i18n._( 'is incorrect, perhaps it should be' ) + ' ' + stepData[key].recommended_base_url + ' ' + $.i18n._( 'instead' ) );
								widget.addClass( 'dataError' );
							}
							break;
						case 'base_dir':
