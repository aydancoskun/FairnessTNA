PayStubViewController = BaseViewController.extend({
    ...
    buildContextMenuModels: function () {
        ...
        for (i = 0; i < direct_deposit_result.length; i++) {
            ...
            var direct_deposit_btn = new RibbonSubMenuNavItem({
                label: direct_deposit_item.label,
...
//		} );
    ...
    initInsideEditorData: function () {
        ...
        if (( !this.current_edit_record || !this.current_edit_record.id ) && !this.copied_record_id) {
            ...
            $this.pay_stub_entry_api['get' + this.pay_stub_entry_api.key_name + 'DefaultData'](args, {
                onResult: function (res) {
                    if (!$this.edit_view) {
                        return;
                    }
    ...
    saveInsideEditorData: function (callBack) {
        ...
        if (data.length > 0) {
            ...
            if (remove_ids.length > 0) {
                this.pay_stub_entry_api.deletePayStubEntry(remove_ids, {
                    onResult: function (res) {
