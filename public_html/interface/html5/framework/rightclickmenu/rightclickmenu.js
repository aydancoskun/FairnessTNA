    ...
    var // currently active contextMenu trigger
        ...
        defaults = {
            ...
            position: function (opt, x, y) {
                ...
                if (offset.top + height > bottom) {
                    ...
                    if (offset.top - height < 5) {
                        offset.top = 5;
                        if (height > $(window).height()) {
                            opt.$menu.height($(window).height() - 10);
                        } else {
        ...
        handle = {
            ...
            itemClick: function (e) {
                ...
                if (e.which === 3 || !opt.items[key] || $this.is('.disabled, .context-menu-submenu, .context-menu-separator, .not-selectable')) {
                    return;
                }
...
//							$t.addClass( "icon icon-" + item.icon );
                                $t.addClass("icon");
                                //Kevin add icon style
                                $t.css("background-size", "15px");
                                $t.css("background-image", "url(" + $('#' + item.icon).children().eq(0).attr('src') + ")");
