...
<div id="rowHeaderLogin"><a href="http://{$ORGANIZATION_URL}"><img src="{if $exception == 'dberror'}{$IMAGES_URL}/logo_wbg_small2.png{else}{$BASE_URL}/send_file.php?object_type=primary_company_logo{/if}" alt="{$ORGANIZATION_NAME}"></a></div>
