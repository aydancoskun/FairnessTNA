...
<div id="container">
    ...
    <div id="rowHeaderLogin"><a href="{$BASE_URL}"><img src="{$BASE_URL}/send_file.php?object_type=primary_company_logo"
                                                        style="width:auto; height:42px;" alt="{$ORGANIZATION_NAME}"></a>
    </div>
    ...
    <div id="rowContentLogin">
        <form method="post" name="password_reset" action="{$smarty.server.SCRIPT_NAME}">
            <div id="contentBox">
                ...
                <div class="textTitle2"><img src="{$IMAGES_URL}lock.gif" width="28" height="28" alt=""
                                             class="imgLock">{$title}</div>
