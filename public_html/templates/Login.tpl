...
<div id="container">
    ...
    <div id="rowHeaderLogin"><a href="http://{$ORGANIZATION_URL}"><img
                    src="{$BASE_URL}/send_file.php?object_type=primary_company_logo" style="width:auto; height:42px;"
                    alt="Time And Attendance"></a></div>

    <div id="rowContentLogin">
        <form method="post" name="login" action="{$smarty.server.SCRIPT_NAME}">
            <div id="contentBox">

                <div class="textTitle2"><img src="{$IMAGES_URL}lock.gif" width="28" height="26" alt="Secure Login"
                                             class="imgLock">
                    {$title}
                    <br></div>
                ...
                <div id="contentBoxTwo">
                    ...
                    <div class="row">
                        ...
                        <div class="cellRight"><input type="text" name="user_name" value="{$user_name}" size="40"></div>
                    </div>
                    <div class="row">
                        <div class="cellLeft">{t}Password{/t}</div>
                        <div class="cellRight"><input type="password" name="password" value="{$password}" size="40"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="33%" align="right"><a
                                    href="javascript:bookmarkSite( '{$APPLICATION_NAME} - {t}Secure Login{/t}', location.href )">{t}Bookmark This Page!{/t}</a>
                        </td>
                    </tr>
                </table>
                <br>
