...
<body id="body"
      onLoad="{*onload_quick_help();*}handleMenuOverlapLogo();onload_column_expand();{$body_onload};firstElementFocus();{if (!isset($newMailPopUp) AND $unread_messages > 0)}newMailPopUp('{$BASE_URL}');{/if}{if time() >= strtotime('15-Jan-2014')}document.getElementById('popUpDiv').className += ' visible';{/if}">
...
<div id="container">
    <div id="rowHeader">
		<span class="imgClientLogo">
			<a href="{$BASE_URL}index.php"><img
                        src="{if $current_company->getLogoFileName() != FALSE}{$BASE_URL}/send_file.php?object_type=company_logo{else}{$IMAGES_URL}logo_wbg_small2.png{/if}"
                        style="width:auto; height:42px; visibility: hidden;" id="header_logo" alt="{$APPLICATION_NAME}"></a>
		</span>
        <div id="rowHeaderContainer">
            ...
            <div id="rowHeaderMenu">M</script>
                ...
                id = "rowBreadcrumbs" >
                    ...
                    < div
                id = "rowError" > {t escape="no" 1=$APPLICATION_NAME}WARNING
                : %
                1
                was
                unable
                ...
                your % 1
                administrator
                immediately.{/t} {if $permission->Check('company','enabled') AND $permission->Check('company','edit_own')}< a
                href = "https://github.com/aydancoskun/fairness?t=40" > {t}For
                more
                information
                please
                click
                ...
                < div
                id = "rowError" > {t escape="no" 1=$APPLICATION_NAME 2=$APPLICATION_VERSION}WARNING
                :
                This % 1
                version(v % 2)
                is
                ...
                the
                latest
                version as soon as possible as invalid
                calculations
                may
                already
                be
