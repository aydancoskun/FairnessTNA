...
<div id="container">
	<div id="rowHeader">
		<span class="imgClientLogo">
			<a href="{$BASE_URL}index.php"><img src="{if $current_company->getLogoFileName() != FALSE}{$BASE_URL}/send_file.php?object_type=company_logo{else}{$IMAGES_URL}logo_wbg_small2.png{/if}" style="width:auto; height:42px; visibility: hidden;" id="header_logo" alt="{$APPLICATION_NAME}"></a>
		</span>
...
<div id="rowBreadcrumbs">
	...
	*}
	...
	<div id="rowError">{t escape="no" 1=$APPLICATION_NAME}WARNING: %1 application version does not match database version. Please re-run the Fairness installer to complete the upgrade process.{/t}</div>
	{/if}
