...
if (!defined('_ADODB_LAYER')) {
    ...
    if (!defined('ADODB_BAD_RS')) {
        define('ADODB_BAD_RS', '<p>Bad $rs in %s. Connection or SQL invalid. Try using $connection->debug=true;</p>');
    }

    // allow [ ] @ ` " and . in table names
    if (!defined('ADODB_TABLE_REGEX')) {
...
abstract class ADOConnection
{
    ...
    public function adodb_strip_count_keyword($sql)
    {
...
class ADORecordSet implements IteratorAggregate
{
    ...
    */
     ...
     *                   (see ADODB_ASSOC_CASE_xxx constants)
     */
    public function GetAssocKeys($upper = ADODB_ASSOC_CASE_UPPER)
    {
        $this->bind = array();
