...
class ADODB_sqlite3 extends ADOConnection
{
    ...
    */
    ...
    public function MetaIndexes($table, $primary = false, $owner = false, $owner = false)
    {
        $false = false;
        // save old fetch mode
        global $ADODB_FETCH_MODE;
...
class ADORecordset_sqlite3 extends ADORecordSet
{
    ...
    public function ADORecordset_sqlite3($queryID, $mode = false)
    {
        if ($mode === false) {
            global $ADODB_FETCH_MODE;
