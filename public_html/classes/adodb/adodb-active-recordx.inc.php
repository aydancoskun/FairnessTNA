...
class ADODB_Active_Record
{
    ...
    public $_dbat; // pluralized table name
    public $_table; // associative index pointing to ADODB_Active_Table, eg $ADODB_Active_DBS[_dbat]->tables[$this->_tableat]
    public $_sTable; // where clause set in Load()
    public $_pTable; // indicates whether data is already inserted.
    public $_tableat; // last error message
    public $_where; // the original values loaded or inserted, refreshed on update
public $_saved = false; // CFR: class name when in a relationship
