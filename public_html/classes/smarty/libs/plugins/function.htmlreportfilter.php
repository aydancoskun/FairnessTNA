...
function smarty_function_htmlReportFilter($params, &$smarty)
{
    ...
    $type_dst_html = NULL;
    if ( $type == 'job' ) {
        $type_src_html = '<b>Code:</b> <input type="text" size="4" id="src_quick_job_id_'. $label .'" onKeyUp="FAIRNESS.punch.selectJobOption( \'src_quick_job_id_'. $label .'\', \'src_filter_'. $label .'\' );">';
        $type_dst_html = '<b>Code:</b> <input type="text" size="4" id="quick_job_id_'. $label .'" onKeyUp="FAIRNESS.punch.selectJobOption( \'quick_job_id_'. $label .'\', \'filter_'. $label .'\' );">';
    }
