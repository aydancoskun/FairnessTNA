...
class TimesheetDetailReport extends Report
{
    ...
    public function _preProcess($format = null)
    {
    ...
    public function splitDataByHoursWorked($row, $dynamic_columns)
    {
        $retval = array();
    ...
    public function _outputPDFTimesheet($format)
    {
    ...
    public function timesheetHeader($user_data)
    {
        $margins = $this->pdf->getMargins();
    ...
    public function timesheetHandleDayGaps($start_date, $end_date, $format, $columns, $column_widths, $user_data, $data, $prev_data)
    {
    ...
    public function timesheetDayRow($format, $columns, $column_widths, $user_data, $data, $prev_data)
    {
    ...
    public function timesheetCheckPageBreak($height, $add_page = true)
    {
        $margins = $this->pdf->getMargins();
    ...
    public function timesheetAddPage()
    {
    ...
    public function timesheetFooter()
    {
        $margins = $this->pdf->getMargins();
    ...
    public function timesheetWeekTotal($column_widths, $week_totals)
    {
    ...
    public function timesheetPayPeriodHeader($user_data, $data)
    {
    ...
    public function timesheetWeekHeader($column_widths)
    {
        $line_h = $this->_pdf_scaleSize(5);
    ...
    public function timesheetTotal($column_widths, $totals)
    {
        $line_h = $this->_pdf_scaleSize(6);
    ...
    public function timesheetSignature($user_data, $data)
    {
        $border = 0;
    ...
    public function timesheetNoData()
    {
        $margins = $this->pdf->getMargins();
