...
class GeneralLedgerSummaryReport extends Report
{
    ...
    public function calculatePercentDistribution($user_date_total_arr, $pay_period_total_arr)
    {
    ...
    public function expandGLAccountRows($psen_data, $distribution_arr, $branch_code_map, $department_code_map, $job_code_map, $job_item_code_map, $replace_arr)
    {
    ...
    public function calcPercentDistribution($type, $psen_data, $distribution_arr, $branch_code_map, $department_code_map, $job_code_map, $job_item_code_map, $tmp_replace_arr)
    {
    ...
    public function replaceGLAccountVariables($subject, $replace_arr = null)
    {
        $search_arr = array(
            //*NOTE*: If this changes you must change numeric indexes in calcPercentDistribution().
            '#default_branch#',
    ...
    public function _outputExportGeneralLedger($format)
    {
