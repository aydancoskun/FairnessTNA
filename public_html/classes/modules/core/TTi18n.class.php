...
class TTi18n
{
    ...
    private static $master_locale = null;
    private static $locale = null;
    private static $normalized_locale = null;
    private static $is_default_locale = true;

    private static $currency_formatter = false;
    private static $number_formatter = false;

    //default precision is 2 to stay consistent with legacy code.
    private static $DEFAULT_NUMBER_FORMAT_PATTERN = '#,##0.##';

    public static function setGetTextLocale($locale)
    {
    ...
    */
    ...
    public static function getLocaleArrayAsString($locale_arr)
    {
    ...
    public static function generateLocale($locale_arg = null)
    {
     ...
     * @return string
     */
    protected static function _normalizeLocale($locale)
    {
    ...
    public static function stripUTF8($str)
    {
    ...
    public static function setMasterLocale()
    {
    ...
    public static function setLocale($locale_arg = null, $category = LC_ALL, $force = false)
    {
...
//				}
    ...
    public static function getLocaleCookie()
    {
    ...
    public static function getCountryFromLocale($locale = null)
    {
        if ($locale == '') {
            $locale = self::getLocale();
        }
    ...
    public static function getNormalizedLocale()
    {
    ...
    */
    ...
    public static function gt($str, $args = false)
    {
        return self::getText($str, $args);
    }

    public static function getText($str, $args = false)
    {
        if ($args != '') {
    ...
    public static function getTextStringArgs($str, $args)
    {
        if ($args != '') {
            if (!is_array($args)) {
                $args = (array)$args;
    ...
    public static function getPDFDefaultFont($language = null, $encoding = false)
    {
        if ($language == '') {
    ...
    */
    ...
    public static function formatCurrency($amount, $currency_code = null, $show_code = 0)
    {
    ...
    public static function getCurrencySymbol($iso_code)
    {
     ...
     */
    public static function formatNumber($number, $auto_format_decimals = false, $min_decimals = 2, $max_decimals = 4)
    {
