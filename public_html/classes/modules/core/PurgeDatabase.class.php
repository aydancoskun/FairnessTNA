...
class PurgeDatabase
{
    public static $parent_table_column_map = array(
        'users' => 'user_id',
        'report_schedule' => 'user_report_data_id',
    );

    public static $parent_table_map_array = array(
    ...
    public static function getParentTableMap()
    {
        global $db;

        //Get all tables in a database and their ID columns to aid in creating export/import mapping
        $exclude_columns = array('id', 'type_id', 'status_id', 'length_of_service_unit_id', 'apply_frequency_id', 'category_id', 'other_id1', 'other_id2', 'other_id3', 'other_id4', 'other_id5', 'ibutton_id', 'manual_id', 'exclusive_id', 'session_id', 'cc_type_id', 'originator_id', 'data_center_id', 'calculation_id', 'severity_id', 'email_notification_id', 'default_schedule_status_id', 'phone_id', 'sex_id');
