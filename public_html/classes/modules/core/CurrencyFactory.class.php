...
class CurrencyFactory extends Factory
{
    ...
    public static function convertCurrency($src_currency_id, $dst_currency_id, $amount = 1)
    {
    ...
    public static function convert($src_rate, $dst_rate, $amount, $round_decimal_places = 2)
    {
    ...
    public static function updateCurrencyRates($company_id)
    {
        $base_currency = false;
    ...
    public static function getISOCodesArray()
    {
    ...
    public function setActualRate($value)
    {
        $value = trim($value);
    ...
    public function getActualRateUpdatedDate()
    {
    ...
    public function setActualRateUpdatedDate($epoch = null)
    {
    ...
    public function getPercentModifiedRate($rate)
    {
    ...
    public function getRateModifyPercent()
    {
    ...
    public function isUniqueDefault()
    {
        $ph = array(
    ...
    public function setRoundDecimalPlaces($value)
    {
    ...
    public function getBaseCurrencyAmount($amount, $rate, $convert = true)
    {
    ...
    public function setRateModifyPercent($value)
    {
