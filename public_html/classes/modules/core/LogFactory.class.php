...
class LogFactory extends Factory
{
    public $user_obj = null;
        protected $table = 'system_log'; //PK Sequence name
protected $pk_sequence_name = 'system_log_id_seq';
    ...
    public function setTableName($text)
    {
        $text = trim($text);
    ...
    public function addEntry($object_id, $action_id, $description = null, $user_id = null, $table = null)
    {
        if ($object_id == '') {
            return false;
        }
    ...
    public function setDate($epoch = null)
    {
