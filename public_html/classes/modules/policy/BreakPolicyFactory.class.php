...
class BreakPolicyFactory extends Factory
{
    ...
    public function getIncludeBreakPunchTime()
    {
    ...
    public function setIncludeBreakPunchTime($bool)
    {
    ...
    public function getIncludeMultipleBreaks()
    {
    ...
    public function setIncludeMultipleBreaks($bool)
    {
