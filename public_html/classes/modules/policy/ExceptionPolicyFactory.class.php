...
class ExceptionPolicyFactory extends Factory
{
    protected static $premature_exceptions = array('M2', 'M3', 'M4', 'L3', 'B4', 'B5', 'S8');
        protected static $premature_delay = 57600; //PK Sequence name
    protected $table = 'exception_policy';
protected $pk_sequence_name = 'exception_policy_id_seq';
    ...
    public static function isPreMature($code)
    {
    ...
    public static function diffExistingAndCurrentExceptions($existing_exceptions, $current_exceptions)
    {
    ...
    public function getExceptionPolicyControlObject()
    {
    ...
    public function getExceptionPolicyControl()
    {
    ...
    public function setExceptionPolicyControl($id)
    {
        $id = trim($id);
    ...
    public function getExceptionTypeDefaultValues($exclude_exceptions)
    {
    ...
    public function isEnabledGrace($code = null)
    {
        if ($code == null) {
            $code = $this->getType();
        }
    ...
    public function isEnabledWatchWindow($code = null)
    {
        if ($code == null) {
            $code = $this->getType();
        }
    ...
    {
        return Option::getByKey($this->getType(), $this->getTypeOptions());
    }
    ...
    public function getWatchWindow()
    {
    ...
    public function setWatchWindow($value)
    {
        $value = trim($value);
    ...
    public function setDemerit($value)
    {
        $value = trim($value);
    ...
    public function isUnique($exception_policy_control_id, $type_id, $id)
    {
        $ph = array(
