...
class PremiumPolicyListFactory extends PremiumPolicyFactory implements IteratorAggregate
{
    ...
    public function getByPolicyGroupUserIdOrSchedulePolicyID($user_id, $id, $where = null, $order = null)
    {
        if ($user_id == '') {
            return false;
        }
    ...
    public function getByCompanyIdArray($company_id, $include_blank = true, $where = null)
    {
