...
class AccrualPolicyFactory extends Factory
{
    ...
    public function getEnablePayStubBalanceDisplay()
    {
        return $this->fromBool($this->data['enable_pay_stub_balance_display']);
    }

    public function setEnablePayStubBalanceDisplay($bool)
    {
    ...
    public function setApplyFrequencyHireDate($bool)
    {
    ...
    public function setEnableProRateInitialPeriod($bool)
    {
    ...
    public function setEnableOpeningBalance($bool)
    {
    ...
    public function setMilestoneRolloverHireDate($bool)
    {
    ...
    public function setMilestoneRolloverMonth($value)
    {
        $value = trim($value);
    ...
    public function setMilestoneRolloverDayOfMonth($value)
    {
        $value = trim($value);
    ...
    public function isHourBasedLengthOfService()
    {
    ...
    public function getAccrualBalanceWithProjection($u_obj, $epoch, $current_time, $previous_time = 0, $other_policy_balance_arr = false)
    {
    ...
    public function getProjectedAccrualAmount($u_obj, $start_epoch, $end_epoch)
    {
    ...
    public function getPayPeriodArray($pps_obj, $u_obj, $start_epoch, $end_epoch)
    {
        $retarr = array();
    ...
    public function calcAccrualPolicyTime($u_obj, $epoch, $offset, $pps_obj, $pay_period_arr, $accrual_balance, $update_records = true)
    {
        $retval = 0;
    ...
    public function getPayPeriodDatesFromArray($pay_period_arr, $epoch)
    {
    ...
    public function inApplyFrequencyWindow($current_epoch, $offset, $pay_period_dates = null, $u_obj = null)
    {
    ...
    public function getEnableOpeningBalance()
    {
    ...
    public function isInitialApplyFrequencyWindow($current_epoch, $offset, $pay_period_dates = null, $u_obj = null)
    {
        $apply_frequency_dates = $this->getApplyFrequencyWindowDates($current_epoch, $offset, $pay_period_dates, $u_obj);
        if (isset($apply_frequency_dates['start_date']) and isset($apply_frequency_dates['end_date'])) {
    ...
    public function inRolloverFrequencyWindow($current_epoch, $offset, $u_obj, $pay_period_start_date = null)
    {
    ...
    public function getCurrentMilestoneRolloverDate($epoch, $u_obj = null, $use_previous_year_date = false)
    {
        if (!is_object($u_obj)) {
            return false;
        }
    ...
    public function getModifiedHireDate($u_obj, $modifier_obj = null)
    {
        if (!is_object($u_obj)) {
            return false;
        }
    ...
    public function getAccrualPolicyUserModifierObject($u_obj)
    {
        if (!is_object($u_obj)) {
            return false;
        }
    ...
    public function getMilestoneRolloverDate($u_obj = null, $modifier_obj = null)
    {
        if (!is_object($u_obj)) {
            return false;
        }
    ...
    public function getMilestoneRolloverHireDate()
    {
    ...
    public function getMilestoneRolloverMonth()
    {
    ...
    public function getMilestoneRolloverDayOfMonth()
    {
    ...
    public function getActiveMilestoneObject($u_obj, $epoch = null, $worked_time = 0, $modifier_obj = false)
    {
        if (!is_object($u_obj)) {
            return false;
        }
    ...
    public function calcAccrualAmount($milestone_obj, $total_time, $annual_pay_periods)
    {
    ...
    public function getAccrualRatePerTimeFrequency($accrual_rate, $annual_pay_periods = null)
    {
        $retval = false;
    ...
    public function getEnableProRateInitialPeriod()
    {
    ...
    public function getProRateInitialFrequencyWindow($input_amount, $current_epoch, $offset, $pay_period_dates = null, $u_obj = null)
    {
        $apply_frequency_dates = $this->getApplyFrequencyWindowDates($current_epoch, $offset, $pay_period_dates, $u_obj);
        if (isset($apply_frequency_dates['start_date']) and isset($apply_frequency_dates['end_date'])) {
    ...
    public function getApplyFrequencyWindowDates($current_epoch, $offset, $pay_period_dates = null, $u_obj = null)
    {
    ...
    public function getApplyFrequencyHireDate()
    {
    ...
    public function addAccrualPolicyTime($epoch = null, $offset = 79200, $user_ids = false)
    {
        if ($epoch == '') {
            $epoch = TTDate::getTime();
        }
