...
class UserDeductionFactory extends Factory
{
    public $user_obj = null;
        public $company_deduction_obj = null; //PK Sequence name
    public $pay_stub_entry_account_link_obj = null;
    protected $table = 'user_deduction';
protected $pk_sequence_name = 'user_deduction_id_seq';
    ...
    public function getDescription($transaction_date = false)
    {
        $retval = false;
    ...
    public function getCompanyDeductionObject()
    {
    ...
    public function getDeductionAmount($user_id, $pay_stub_obj, $pay_period_obj, $formula_type_id = 10, $payroll_run_id = 1)
    {
        if ($user_id == '') {
        ...
        switch ($cd_obj->getCalculation()) {
            ...
            case 15: //Advanced Percent
                ...
                if ($percent != 0) {
                    ...
                    if ($wage_base > 0) {
                        //*NOTE: If the first pay stub in FairnessTNA is near the end of the year, and the employee has already exceeded the wage base amount
    ...
    public function getMaximumPayStubEntryAccountAmount()
    {
        $retval = false;
    ...
    public function isUniqueCompanyDeduction($deduction_id)
    {
        $ph = array(
    ...
    public function getLengthOfServiceDate($raw = false)
    {
        $retval = false;
    ...
    public function setLengthOfServiceDate($epoch)
    {
        if ($epoch != '') {
