...
class ROEFactory extends Factory
{
    ...
    public $initial_pay_period_earnings = null;
    public $pay_period_earnings = null;
    protected $table = 'roe';
protected $pk_sequence_name = 'roe_id_seq';
    ...
    public function setPayPeriodType($value)
    {
        $value = trim($value);
    ...
    public function setVacationPay($value)
    {
        $value = trim($value);
    ...
    public function setEnableReCalculate($bool)
    {
        $this->recalc = $bool;
    ...
    public function setEnableReleaseAccruals($bool)
    {
    ...
    public function setEnableGeneratePayStub($bool)
    {
    ...
    public function calculateFirstDate()
    {
    ...
    public function calculateFinalPayStubEndDate()
    {
        $user_id = $this->getUser();
    ...
    public function calculateFinalPayStubTransactionDate()
    {
        $user_id = $this->getUser();
    ...
    public function isFinalPayStubExists()
    {
        $user_id = $this->getUser();
    ...
    public function calculatePayPeriodType($date)
    {
        $user_id = $this->getUser();
    ...
    public function combinePostTerminationPayPeriods($data)
    {
        $retarr = array();
    ...
    public function isPayPeriodWithNoEarnings()
    {
    ...
    public function getLastPayPeriodVacationEarnings()
    {
    ...
    public function getInsurableEarningsByPayPeriod($line = '15c')
    {
    ...
    public function getInsurablePayPeriodStartDate($pay_periods)
    {
    ...
    public function getFinalPayStubEndDate()
    {
    ...
    public function getInsurableEarningsReportPayPeriods($line = '15b')
    {
        if ($line == '15b') {
    ...
    public function getFinalPayStubTransactionDate()
    {
    ...
    public function getEnableReleaseAccruals()
    {
    ...
    public function getInsurableHours()
    {
    ...
    public function setInsurableHours($value)
    {
        $value = trim($value);
    ...
    public function getInsurableEarnings()
    {
    ...
    public function setInsurableEarnings($value)
    {
        $value = trim($value);
        if ($value == '' or $value == null) {
            $value = 0;
    ...
    public function getEnableReCalculate()
    {
    ...
    public function getEnableGeneratePayStub()
    {
    ...
    public function getInsurableHoursReportPayPeriods()
    {
        return $this->getInsurableEarningsReportPayPeriods('15c');
    }

    public function getTotalInsurableEarnings()
    {
        $total_earnings = 0;
    ...
    public function setFirstDate($epoch)
    {
    ...
    public function setLastDate($epoch)
    {
        $epoch = (!is_int($epoch)) ? trim($epoch) : $epoch; //Dont trim integer values, as it changes them to strings.
    ...
    public function setPayPeriodEndDate($epoch)
    {
        $epoch = (!is_int($epoch)) ? trim($epoch) : $epoch; //Dont trim integer values, as it changes them to strings.
    ...
    public function setRecallDate($epoch)
    {
        $epoch = (!is_int($epoch)) ? trim($epoch) : $epoch; //Dont trim integer values, as it changes them to strings.
        if ($epoch == '') {
            $epoch = null;
    ...
    public function setFinalPayStubEndDate($epoch)
    {
        $epoch = (!is_int($epoch)) ? trim($epoch) : $epoch; //Dont trim integer values, as it changes them to strings.
    ...
    public function setFinalPayStubTransactionDate($epoch)
    {
        $epoch = (!is_int($epoch)) ? trim($epoch) : $epoch; //Dont trim integer values, as it changes them to strings.
    ...
    public function getVacationPay()
    {
