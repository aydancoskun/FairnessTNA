...
$eft->setDataCenter(00400);
    ...
    $record->setOriginatorShortName( 'FairnessTNA' );
    $record->setOriginatorLongName( 'FairnessTNA Payroll Services' );
...
class EFT
{
    public $file_format_options = array('1464', '105', 'HSBC', 'BEANSTREAM', 'ACH');
    public $file_format = null; //File format
    public $line_ending = "\r\n";

    public $file_prefix_data = null; //Leading data in the file, primarily for RBC routing lines.
    public $header_data = null;
    public $data = null;

    public $compiled_data = null;
    ...
    public function setFileCreationDate($value)
    {
        if ($value != '') {
    ...
    public function toJulian($epoch)
    {
    ...
    public function getInitialEntryNumber()
    {
    ...
    public function setInitialEntryNumber($value)
    {
    ...
    public function setDataCenterName($value)
    {
        $value = trim($value);
    ...
    public function setBatchBusinessNumber($value)
    {
        if ($this->isAlphaNumeric($value) and strlen($value) <= 10) {
    ...
    public function setBatchServiceCode($value)
    {
    ...
    public function setBatchEntryDescription($value)
    {
        $value = strtoupper(trim($value));
        if ($this->isAlphaNumeric($value) and strlen($value) <= 10) {
    ...
    public function getBatchBusinessNumber()
    {
    ...
    public function getBatchServiceCode()
    {
    ...
    public function getBatchEntryDescription()
    {
    ...
    public function padLine($line, $length)
    {
    ...
    */
    ...
    public function getFilePrefixData()
    {
    ...
    public function setFilePrefixData($data)
    {
...
class EFT_record extends EFT
{
    ...
    public function setCPACode($value)
    {
        //200 - Payroll deposit
    ...
    public function setEntryDescription($value)
    {
        $value = strtoupper(trim($value));
        if ($this->isAlphaNumeric($value) and strlen($value) <= 10) {
    ...
    public function getOriginatorReferenceNumber()
    {
    ...
    public function setOriginatorReferenceNumber($value)
    {
    ...
    public function getReturnInstitution()
    {
    ...
    public function setReturnInstitution($value)
    {
        //Must be 0004 for TD?
        if ($this->isNumeric($value) and strlen($value) <= 3) {
    ...
    public function getReturnTransit()
    {
    ...
    public function setReturnTransit($value)
    {
    ...
    public function setReturnAccount($value)
    {
...
class EFT_File_Format_1464 extends EFT
{
    ...
    public function __construct($header_data, $data)
    {
...
class EFT_File_Format_ACH extends EFT
{
    ...
    */
    ...
    public function compileFileControlPadding($compiled_data)
    {
