...
class RecurringScheduleListFactory extends RecurringScheduleFactory implements IteratorAggregate
{
    ...
    public function getByRecurringScheduleControlID($recurring_schedule_control_id, $where = null, $order = null)
    {
    ...
    public function getMinimumStartTimeByRecurringScheduleControlID($recurring_schedule_control_id, $where = null)
    {
        if ($recurring_schedule_control_id == '') {
            return false;
        }
    ...
    public function getByRecurringScheduleControlIDAndStartDateAndEndDate($recurring_schedule_control_id, $start_date, $end_date, $where = null, $order = null)
    {
        if ($recurring_schedule_control_id == '') {
            return false;
        }
    ...
    public function getByRecurringScheduleControlIDAndUserIdAndStartDateAndEndDate($recurring_schedule_control_id, $user_id, $start_date, $end_date, $where = null, $order = null)
    {
        if ($recurring_schedule_control_id == '') {
            return false;
        }
    ...
    public function getByCompanyIDAndStartDateAndEndDateAndNoConflictingSchedule($company_id, $start_date, $end_date, $where = null, $order = null)
    {
        if ($company_id == '') {
            return false;
        }
