...
class ScheduleListFactory extends ScheduleFactory implements IteratorAggregate
{
    ...
    public function getByUserIdAndDateStampAndStatus($user_id, $date_stamp, $status_id, $where = null, $order = null)
    {
        if ($user_id == '') {
            return false;
        }
    ...
    public function getWeekWorkTimeSumByUserIDAndEpochAndStartWeekEpoch($user_id, $epoch, $week_start_epoch)
    {
        if ($user_id == '') {
            return false;
        }
    ...
    public function getByUserIdAndTypeAndDirectionFromDate($user_id, $type_id, $direction, $date, $limit = null, $page = null, $where = null, $order = null)
    {
        if ($user_id == '') {
            return false;
        }
    ...
    public function getConflictingByUserIdAndStartDateAndEndDate($user_id, $start_date, $end_date, $id = null, $where = null, $order = null)
    {
    ...
    public function getScheduleObjectByUserIdAndEpoch($user_id, $epoch)
    {
        if ($user_id == '') {
            return false;
        }
    ...
    public function getMostCommonScheduleDataByCompanyIdAndUserAndStartDateAndEndDate($company_id, $user_id, $start_date, $end_date)
    {
        if ($company_id == '') {
            return false;
        }
    ...
    public function getConflictingOpenShiftSchedule($company_id, $start_time, $end_time, $branch_id, $department_id, $job_id, $job_item_id, $replaced_id = 0, $limit = null, $page = null, $where = null, $order = null)
    {
    ...
    public function getOverriddenOpenShiftRecurringSchedules($company_id, $filter_data, $limit = null, $page = null, $where = null, $order = null)
    {
        if ($company_id == '') {
            return false;
        }
