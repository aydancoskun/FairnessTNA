...
class APIDepartment extends APIFactory
{
     ...
     * @return array
     */
    public function getDepartmentDefaultData()
    {
     ...
     * @return array
     */
    public function exportDepartment($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getDepartment($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonDepartmentData($data)
    {
     ...
     * @return array
     */
    public function setDepartment($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function copyDepartment($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
        ...
        $src_rows = $this->stripReturnHandler($this->getDepartment(array('filter_data' => array('id' => $data)), true));
