...
class APIUserGroup extends APIFactory
{
     ...
     * @return array
     */
    public function getUserGroupDefaultData()
    {
     ...
     * @return array
     */
    public function getCommonUserGroupData($data)
    {
     ...
     * @return array
     */
    public function getUserGroup($data = null, $disable_paging = false, $mode = 'flat')
    {
     ...
     * @return array
     */
    public function validateUserGroup($data)
    {
     ...
     * @return array
     */
    public function setUserGroup($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function dragNdropUserGroup($src_id, $dst_id)
    {
        if (!is_array($src_id)) {
            $src_id = array($src_id);
        }
