...
class APIUserDefault extends APIFactory
{
     ...
     * @return array
     */
    public function getUserDefaultDefaultData()
    {
     ...
     * @return array
     */
    public function getCommonUserDefaultData($data)
    {
     ...
     * @return array
     */
    public function getUserDefault($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function validateUserDefault($data)
    {
     ...
     * @return array
     */
    public function setUserDefault($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteUserDefault($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyUserDefault($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
