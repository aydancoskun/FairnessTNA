...
class APIBranch extends APIFactory
{
     ...
     * @return array
     */
    public function getBranchDefaultData()
    {
     ...
     * @return array
     */
    public function exportBranch($format = 'csv', $data = null, $disable_paging = true)
    {
        $result = $this->stripReturnHandler($this->getBranch($data, $disable_paging));
        return $this->exportRecords($format, 'export_branch', $result, ((isset($data['filter_columns'])) ? $data['filter_columns'] : null));
    }
     ...
     * @return array
     */
    public function getBranch($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonBranchData($data)
    {
     ...
     * @return array
     */
    public function setBranch($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function copyBranch($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
