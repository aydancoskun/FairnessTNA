...
class APIWageGroup extends APIFactory
{
     ...
     * @return array
     */
    public function getWageGroupDefaultData()
    {
     ...
     * @return array
     */
    public function exportWageGroup($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getWageGroup($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonWageGroupData($data)
    {
     ...
     * @return array
     */
    public function validateWageGroup($data)
    {
     ...
     * @return array
     */
    public function setWageGroup($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteWageGroup($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyWageGroup($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
