...
class APICurrency extends APIFactory
{
     ...
     * @return array
     */
    public function getCurrencyDefaultData()
    {
     ...
     * @return array
     */
    public function exportCurrency($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getCurrency($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonCurrencyData($data)
    {
     ...
     * @return array
     */
    public function setCurrency($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function copyCurrency($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
    ...
    public function getISOCodesArray()
    {
