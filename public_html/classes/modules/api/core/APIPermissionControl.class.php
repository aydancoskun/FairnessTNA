...
class APIPermissionControl extends APIFactory
{
     ...
     * @return array
     */
    public function getPermissionControlDefaultData()
    {
     ...
     * @return array
     */
    public function exportPermissionControl($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getPermissionControl($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonPermissionControlData($data)
    {
     ...
     * @return array
     */
    public function validatePermissionControl($data)
    {
     ...
     * @return array
     */
    public function setPermissionControl($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deletePermissionControl($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyPermissionControl($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
