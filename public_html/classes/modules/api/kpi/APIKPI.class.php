...
class APIKPI extends APIFactory
{
     ...
     * @return array
     */
    public function getKPIDefaultData()
    {
     ...
     * @return array|bool
     */
    public function exportKPI($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getKPI($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonKPIData($data)
    {
     ...
     * @return array
     */
    public function validateKPI($data)
    {
     ...
     * @return array
     */
    public function setKPI($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteKPI($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
