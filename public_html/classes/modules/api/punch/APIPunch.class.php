...
class APIPunch extends APIFactory
{
    ...
    public function getUserPunch($user_id = null, $epoch = null, $station_id = null, $company_id = null)
    {
        if ($epoch == '') {
    ...
    public function setUserPunch($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function getRequestDefaultData($user_id = null, $date = null, $punch_control_id = null, $previous_punch_id = null, $status_id = 10, $type_id = 10, $current_punch_id = null)
    {
        if (!is_numeric($user_id)) {
            $user_id = $this->getCurrentUserObject()->getId();
        }
     ...
     * @return array
     */
    public function getPunch($data = null, $disable_paging = false)
    {
        if (!$this->getPermissionObject()->Check('punch', 'enabled')
     ...
     * @return array
     */
    public function getPunchDefaultData($user_id = null, $date = null, $punch_control_id = null, $previous_punch_id = null, $status_id = null, $type_id = null)
    {
     ...
     * @return array
     */
    public function getCommonPunchData($data)
    {
     ...
     * @return array
     */
    public function validatePunch($data)
    {
     ...
     * @return array
     */
    public function setPunch($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deletePunch($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
    ...
    public function getMealAndBreakTotalTime($data, $disable_paging = false)
    {
     ...
     * @return array|bool
     */
    public function exportPunch($format = 'csv', $data = null, $disable_paging = true)
    {
