...
class APIUserLanguage extends APIFactory
{
     ...
     * @return array
     */
    public function getUserLanguageDefaultData()
    {
        $data = array();
     ...
     * @return array|bool
     */
    public function exportUserLanguage($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getUserLanguage($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonUserLanguageData($data)
    {
     ...
     * @return array
     */
    public function validateUserLanguage($data)
    {
     ...
     * @return array
     */
    public function setUserLanguage($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteUserLanguage($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyUserLanguage($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
