...
class APIQualificationGroup extends APIFactory
{
     ...
     * @return array
     */
    public function getQualificationGroupDefaultData()
    {
     ...
     * @return array
     */
    public function getCommonQualificationGroupData($data)
    {
     ...
     * @return array
     */
    public function getQualificationGroup($data = null, $disable_paging = false, $mode = 'flat')
    {
     ...
     * @return array
     */
    public function validateQualificationGroup($data)
    {
     ...
     * @return array
     */
    public function setQualificationGroup($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteQualificationGroup($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyQualificationGroup($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function dragNdropQualificationGroup($src_id, $dst_id)
    {
        if (!is_array($src_id)) {
            $src_id = array($src_id);
        }
