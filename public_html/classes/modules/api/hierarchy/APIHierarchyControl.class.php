...
class APIHierarchyControl extends APIFactory
{
     ...
     * @return array
     */
    public function getHierarchyControlDefaultData()
    {
     ...
     * @return array
     */
    public function exportHierarchyControl($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getHierarchyControl($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonHierarchyControlData($data)
    {
     ...
     * @return array
     */
    public function validateHierarchyControl($data)
    {
     ...
     * @return array
     */
    public function setHierarchyControl($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteHierarchyControl($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyHierarchyControl($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
