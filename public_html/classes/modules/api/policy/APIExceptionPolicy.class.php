...
class APIExceptionPolicy extends APIFactory
{
     ...
     * @return array
     */
    public function getExceptionPolicyDefaultData()
    {
     ...
     * @return array
     */
    public function getCommonExceptionPolicyData($data)
    {
     ...
     * @return array
     */
    public function getExceptionPolicy($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function validateExceptionPolicy($data)
    {
     ...
     * @return array
     */
    public function setExceptionPolicy($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteExceptionPolicy($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyExceptionPolicy($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
