...
class APIAccrualPolicyAccount extends APIFactory
{
     ...
     * @return array
     */
    public function getAccrualPolicyAccountDefaultData()
    {
     ...
     * @return array|bool
     */
    public function exportAccrualPolicyAccount($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getAccrualPolicyAccount($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonAccrualPolicyAccountData($data)
    {
     ...
     * @return array
     */
    public function validateAccrualPolicyAccount($data)
    {
     ...
     * @return array
     */
    public function setAccrualPolicyAccount($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteAccrualPolicyAccount($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyAccrualPolicyAccount($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
