...
class APIRoundIntervalPolicy extends APIFactory
{
     ...
     * @return array
     */
    public function getRoundIntervalPolicyDefaultData()
    {
     ...
     * @return array|bool
     */
    public function exportRoundIntervalPolicy($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getRoundIntervalPolicy($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonRoundIntervalPolicyData($data)
    {
        return Misc::arrayIntersectByRow($this->stripReturnHandler($this->getRoundIntervalPolicy($data, true)));
    }
     ...
     * @return array
     */
    public function validateRoundIntervalPolicy($data)
    {
     ...
     * @return array
     */
    public function setRoundIntervalPolicy($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteRoundIntervalPolicy($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyRoundIntervalPolicy($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
        ...
        $src_rows = $this->stripReturnHandler($this->getRoundIntervalPolicy(array('filter_data' => array('id' => $data)), true));
