...
class APIMealPolicy extends APIFactory
{
     ...
     * @return array
     */
    public function getMealPolicyDefaultData()
    {
     ...
     * @return array|bool
     */
    public function exportMealPolicy($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getMealPolicy($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonMealPolicyData($data)
    {
     ...
     * @return array
     */
    public function validateMealPolicy($data)
    {
     ...
     * @return array
     */
    public function setMealPolicy($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteMealPolicy($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyMealPolicy($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
