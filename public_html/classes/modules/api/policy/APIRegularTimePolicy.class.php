...
class APIRegularTimePolicy extends APIFactory
{
     ...
     * @return array
     */
    public function getRegularTimePolicyDefaultData()
    {
     ...
     * @return array|bool
     */
    public function exportRegularTimePolicy($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getRegularTimePolicy($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonRegularTimePolicyData($data)
    {
     ...
     * @return array
     */
    public function validateRegularTimePolicy($data)
    {
     ...
     * @return array
     */
    public function setRegularTimePolicy($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteRegularTimePolicy($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyRegularTimePolicy($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
