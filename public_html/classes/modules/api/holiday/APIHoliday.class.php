...
class APIHoliday extends APIFactory
{
     ...
     * @return array
     */
    public function getHolidayDefaultData()
    {
     ...
     * @return array
     */
    public function getCommonHolidayData($data)
    {
        return Misc::arrayIntersectByRow($this->stripReturnHandler($this->getHoliday($data, true)));
    }
     ...
     * @return array
     */
    public function getHoliday($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function setHoliday($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function copyHoliday($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
        ...
        $src_rows = $this->stripReturnHandler($this->getHoliday(array('filter_data' => array('id' => $data)), true));
