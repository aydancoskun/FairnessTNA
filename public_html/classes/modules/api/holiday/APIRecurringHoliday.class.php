...
class APIRecurringHoliday extends APIFactory
{
     ...
     * @return array
     */
    public function getRecurringHolidayDefaultData()
    {
     ...
     * @return array|bool
     */
    public function exportRecurringHoliday($format = 'csv', $data = null, $disable_paging = true)
    {
        $result = $this->stripReturnHandler($this->getRecurringHoliday($data, $disable_paging));
        return $this->exportRecords($format, 'export_recurring_holiday', $result, ((isset($data['filter_columns'])) ? $data['filter_columns'] : null));
    }
     ...
     * @return array
     */
    public function getRecurringHoliday($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonRecurringHolidayData($data)
    {
     ...
     * @return array
     */
    public function validateRecurringHoliday($data)
    {
     ...
     * @return array
     */
    public function setRecurringHoliday($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteRecurringHoliday($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyRecurringHoliday($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
