...
class APIAccrual extends APIFactory
{
     ...
     * @return array
     */
    public function getAccrualDefaultData()
    {
     ...
     * @return array
     */
    public function exportAccrual($format = 'csv', $data = null, $disable_paging = true)
    {
     ...
     * @return array
     */
    public function getAccrual($data = null, $disable_paging = false)
    {
     ...
     * @return array
     */
    public function getCommonAccrualData($data)
    {
     ...
     * @return array
     */
    public function validateAccrual($data)
    {
     ...
     * @return array
     */
    public function setAccrual($data, $validate_only = false, $ignore_warning = true)
    {
     ...
     * @return array
     */
    public function deleteAccrual($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
     ...
     * @return array
     */
    public function copyAccrual($data)
    {
        if (is_numeric($data)) {
            $data = array($data);
        }
