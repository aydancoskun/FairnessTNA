...
class SetupPresets extends Factory
{
    ...
    public function getBreakPolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function createPresets($country = null, $province = null, $district = null, $industry = null, $flags = null)
    {
    ...
    public function PayStubAccounts($country = null, $province = null, $district = null, $industry = null)
    {
    ...
    public function createPayStubAccount($data)
    {
        if (is_array($data)) {
    ...
    public function CompanyDeductions($country = null, $province = null, $district = null, $industry = null)
    {
        //
    ...
    public function createCompanyDeduction($data)
    {
        if (is_array($data)) {
            $cdf = TTnew('CompanyDeductionFactory');
    ...
    public function getPayStubEntryAccountByCompanyIDAndTypeAndFuzzyName($type_id, $name)
    {
    ...
    public function RecurringHolidays($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            //
    ...
    public function createRecurringHoliday($data)
    {
        if (is_array($data)) {
    ...
    public function AccrualPolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            //Time Bank
    ...
    public function createAccrualPolicyAccount($data)
    {
        if (is_array($data)) {
    ...
    public function createAccrualPolicy($data)
    {
        if (is_array($data)) {
    ...
    public function getAccrualPolicyAccountByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function createAccrualPolicyMilestone($data)
    {
        if (is_array($data)) {
    ...
    public function PayFormulaPolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function createPayFormulaPolicy($data)
    {
        if (is_array($data)) {
    ...
    public function PayCode($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function getPayFormulaPolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function ContributingPayCodePolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function createContributingPayCodePolicy($data)
    {
        if (is_array($data)) {
    ...
    public function getPayCodeByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function ContributingShiftPolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function createContributingShiftPolicy($data)
    {
        if (is_array($data)) {
    ...
    public function getContributingPayCodePolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function AbsencePolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
    ...
    public function createAbsencePolicy($data)
    {
        if (is_array($data)) {
    ...
    public function HolidayPolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            switch ($country) {
    ...
    public function createHolidayPolicy($data)
    {
        if (is_array($data)) {
    ...
    public function getAbsencePolicyByCompanyIDAndTypeAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function getRecurringHolidayByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function getContributingShiftPolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function RegularTimePolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
    ...
    public function createRegularTimePolicy($data)
    {
        if (is_array($data)) {
    ...
    public function OverTimePolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            switch ($country) {
    ...
    public function createOverTimePolicy($data)
    {
        if (is_array($data)) {
    ...
    public function MealPolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            switch ($country) {
    ...
    public function createMealPolicy($data)
    {
        if (is_array($data)) {
    ...
    public function BreakPolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            switch ($country) {
    ...
    public function createBreakPolicy($data)
    {
        if (is_array($data)) {
    ...
    public function SchedulePolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            switch ($country) {
    ...
    public function createSchedulePolicy($data)
    {
        if (is_array($data)) {
    ...
    public function getMealPolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function ExceptionPolicy($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            switch ($country) {
    ...
    public function createExceptionPolicy($data)
    {
        if (is_array($data)) {
            ...
            if ($epcf->isValid()) {
                ...
                if ($control_id > 0) {
                    ...
                    $data = $epf->getExceptionTypeDefaultValues(null);
                    if (is_array($data)) {
    ...
    public function PolicyGroup($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province == '') {
            switch ($country) {
    ...
    public function createPolicyGroup($data)
    {
        if (is_array($data)) {
    ...
    public function getRegularTimePolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function getOverTimePolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function getAccrualPolicyByCompanyIDAndTypeAndName($type_id, $name)
    {
        $filter_data = array(
    ...
    public function getHolidayPolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function getExceptionPolicyByCompanyIDAndName($name)
    {
        $filter_data = array(
            'name' => $name
        );
    ...
    public function TaxForms($country = null, $province = null, $district = null, $industry = null)
    {
        Debug::text('Country: ' . $country, __FILE__, __LINE__, __METHOD__, 10);
        if ($country != '' and $province != '') {
            switch ($country) {
    ...
    public function createUserReportData($company_id, $report_obj, $data)
    {
