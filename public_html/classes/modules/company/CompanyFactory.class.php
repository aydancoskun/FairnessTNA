...
{
    public $user_default_obj = null;
        public $user_obj = null; //PK Sequence name
    public $base_currency_obj = null;
    protected $table = 'company';
    protected $pk_sequence_name = 'company_id_seq'; //Short name must only allow characters available in domain names.
...
protected $short_name_validator_regex = '/^[a-zA-Z0-9-]{1,15}$/iu';
    ...
    public function getUserDefaultObject()
    {
    ...
    public function setBusinessNumber($val)
    {
        $val = trim($val);
    ...
    public function setOriginatorID($val)
    {
        $val = trim($val);
    ...
    public function setDataCenterID($val)
    {
        $val = trim($val);
    ...
    public function setAdminContact($id)
    {
        $id = trim($id);
    ...
    public function setBillingContact($id)
    {
        $id = trim($id);
    ...
    public function setSupportContact($id)
    {
        $id = trim($id);
    ...
    public function setEnableAddCurrency($bool)
    {
    ...
    public function setEnableAddPermissionGroupPreset($bool)
    {
    ...
    public function setEnableAddStation($bool)
    {
    ...
    public function setEnableAddPayStubEntryAccountPreset($bool)
    {
    ...
    public function setEnableAddCompanyDeductionPreset($bool)
    {
    ...
    public function setEnableAddUserDefaultPreset($bool)
    {
    ...
    public function getEnableSecondLastName()
    {
    ...
    public function setEnableSecondLastName($bool)
    {
    ...
    public function setMigrateURL($value)
    {
        $value = trim($value);
    ...
    public function setSetupComplete($bool)
    {
    ...
    public function setEnableAddRecurringHolidayPreset($bool)
    {
    ...
    public function isLogoExists()
    {
        return file_exists($this->getLogoFileName());
    }

    public function getLogoFileName($company_id = null, $include_default_logo = true, $primary_company_logo = false, $size = 'normal')
    {
            ...
            if ($include_default_logo == true) {
                ...
                if ($company_id != PRIMARY_COMPANY_ID) {
                    ...
                    if ($primary_company_logo == true and defined('FAIRNESS_API') and FAIRNESS_API === true) {
                        ...
                        $logo_file_name = Environment::getImagesPath() . 'logo_flex_login.png';
                    } else {
                        if (strtolower($size) == 'large') {
                            $logo_file_name = Environment::getImagesPath() . 'logo_wbg_large.png';
                        } else {
                            $logo_file_name = Environment::getImagesPath() . 'logo_wbg_small2.png';
                        }
                    }
                }
            } else {
    ...
    public function getPasswordPolicyType()
    {
    ...
    public function setPasswordPolicyType($type)
    {
        $type = trim($type);
    ...
    public function getPasswordMinimumPermissionLevel()
    {
    ...
    public function setPasswordMinimumPermissionLevel($type)
    {
        $type = trim($type);
    ...
    public function getPasswordMinimumStrength()
    {
    ...
    public function setPasswordMinimumStrength($type)
    {
        $type = trim($type);
    ...
    public function setPasswordMinimumLength($type)
    {
        $type = trim($type);
    ...
    public function getPasswordMinimumAge()
    {
    ...
    public function setPasswordMinimumAge($value)
    {
    ...
    */
    ...
    public function getPasswordMaximumAge()
    {
    ...
    public function setPasswordMaximumAge($value)
    {
        $value = $this->Validator->stripNonNumeric(trim($value));
    ...
    public function getLDAPAuthenticationType()
    {
    ...
    public function setLDAPAuthenticationType($type)
    {
        $type = trim($type);
    ...
    public function setLDAPHost($value)
    {
        $value = trim($value);
    ...
    public function setLDAPPort($value)
    {
        $value = $this->Validator->stripNonNumeric(trim($value));
    ...
    public function getLDAPBindUserName()
    {
    ...
    public function setLDAPBindUserName($value)
    {
        $value = trim($value);
    ...
    public function setLDAPBindPassword($value)
    {
        $value = trim($value);
    ...
    */
    ...
    public function getLDAPBindAttribute()
    {
    ...
    public function setLDAPBindAttribute($value)
    {
        $value = trim($value);
    ...
    public function getLDAPUserFilter()
    {
    ...
    public function setLDAPUserFilter($value)
    {
        $value = trim($value);
    ...
    public function setLDAPLoginAttribute($value)
    {
        $value = trim($value);
    ...
    public function getEncoding($company_id = false)
    {
        if ($company_id == '') {
            $company_id = $this->getID();
        }
    ...
    public function getEnableAddCurrency()
    {
    ...
    public function getEnableAddPermissionGroupPreset()
    {
    ...
    public function getEnableAddStation()
    {
    ...
    public function getEnableAddPayStubEntryAccountPreset()
    {
    ...
    public function getEnableAddCompanyDeductionPreset()
    {
    ...
    public function getEnableAddRecurringHolidayPreset()
    {
    ...
    public function getEnableAddUserDefaultPreset()
    {
