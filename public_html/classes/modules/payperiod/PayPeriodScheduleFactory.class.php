...
class PayPeriodScheduleFactory extends Factory
{
    ...
    public static function getShiftAssignedDate($start_epoch, $end_epoch, $shift_assigned_day_id = false)
    {
    ...
    public function getShiftAssignedDay()
    {
    ...
    public function setStartWeekDay($val)
    {
        $val = trim($val);
    ...
    public function setTransactionDateBusinessDay($int)
    {
        $int = (int)$int;
    ...
    public function getAnchorDate($raw = false)
    {
    ...
    public function setNewDayTriggerTime($int)
    {
        $int = (int)$int;
    ...
    public function setMaximumShiftTime($int)
    {
        $int = (int)$int;
    ...
    public function setTimeSheetVerifyType($type)
    {
        $type = trim($type);
    ...
    public function getTimeSheetVerifyBeforeEndDate()
    {
    ...
    public function setTimeSheetVerifyBeforeEndDate($int)
    {
    ...
    public function getTimeSheetVerifyBeforeTransactionDate()
    {
    ...
    public function setTimeSheetVerifyBeforeTransactionDate($int)
    {
        $int = (float)$int; // Do not cast to INT, need to support partial days.
    ...
    public function getTimeSheetVerifyNoticeBeforeTransactionDate()
    {
    ...
    public function setTimeSheetVerifyNoticeBeforeTransactionDate($int)
    {
        $int = (int)$int;
    ...
    public function getTimeSheetVerifyNoticeEmail()
    {
    ...
    public function setTimeSheetVerifyNoticeEmail($bool)
    {
    ...
    public function createNextPayPeriod($end_date = null, $offset = null, $enable_import_data = true)
    {
    ...
    */
    ...
    public function setPayPeriodTimeZone()
    {
    ...
    public function getNextPayPeriod($end_date = null)
    {
    ...
    public function getStartDayOfWeek($raw = false)
    {
    ...
    public function convertLastDayOfMonth($val)
    {
        if ($val == -1) {
            return 31;
        }
    ...
    public function getPrimaryDayOfMonth()
    {
    ...
    */
    ...
    public function getSecondaryDayOfMonth()
    {
    ...
    public function getPrimaryTransactionDayOfMonth()
    {
    ...
    public function getSecondaryTransactionDayOfMonth()
    {
    ...
    public function getTransactionDateBusinessDay()
    {
        if (isset($this->data['transaction_date_bd'])) {
    ...
    public function getTransactionBusinessDay($epoch)
    {
    ...
    public function setOriginalTimeZone()
    {
    ...
    public function getNextAdvanceEndDate()
    {
    ...
    public function getNextAdvanceTransactionDate()
    {
    ...
    public function getCurrentPayPeriodNumber($epoch = null, $end_date_epoch = null)
    {
    ...
    public function setAnchorDate($epoch)
    {
        $epoch = (int)$epoch;
    ...
    public function setStartDayOfWeek($val)
    {
        $val = trim($val);
    ...
    public function setPrimaryDayOfMonth($val)
    {
        $val = trim($val);
    ...
    public function setSecondaryDayOfMonth($val)
    {
        $val = trim($val);
    ...
    public function setPrimaryTransactionDayOfMonth($val)
    {
        $val = trim($val);
    ...
    public function setSecondaryTransactionDayOfMonth($val)
    {
        $val = trim($val);
    ...
    public function getShiftData($date_stamp = null, $user_id = null, $epoch = null, $filter = null, $tmp_punch_control_obj = null, $maximum_shift_time = null, $new_shift_trigger_time = null, $plf = null, $ignore_future_punches = false)
    {
        global $profiler;
    ...
    public function getMaximumShiftTime()
    {
    ...
    public function getNewDayTriggerTime()
    {
    ...
    public function importData($user_ids = false)
    {
    ...
    public function setEnableInitialPayPeriods($val)
    {
    ...
    public function forceClosePreviousPayPeriods($date = null)
    {
        if ($date == '') {
            $date = time();
        }
    ...
    public function getFirstPayPeriodStartDate()
    {
        $pplf = TTnew('PayPeriodListFactory');
    ...
    public function setDayStartTime($int)
    {
        $int = (int)$int;
    ...
    public function setShiftAssignedDay($val)
    {
        $val = trim($val);
    ...
    public function setAnnualPayPeriods($int)
    {
        $int = (int)$int;
    ...
    public function calcAnnualPayPeriods($type_id = null)
    {
        if ($type_id == '') {
            $type_id = $this->getType();
        }
    ...
    public function getEnableInitialPayPeriods()
    {
    ...
    public function getCreateInitialPayPeriods()
    {
    ...
    public function setCreateInitialPayPeriods($val)
    {
