...
class PayrollDeduction_CA_Data extends PayrollDeduction_Base
{
    ...
    public $country_primary_currency = 'CAD';
    ...
    */
    public $basic_claim_code_options = array(
    ...
    */
    public $federal_employment_credit_options = array(
    ...
    */
    ...
    public function getBasicFederalClaimCodeAmount($date = false)
    {
        if ($date == '') {
            $date = $this->getDate();
        }
    ...
    public function getBasicClaimCodeData($date)
    {
    ...
    public function getBasicProvinceClaimCodeAmount($date = false)
    {
        if ($date == '') {
            $date = $this->getDate();
        }
    ...
    */
    public function getProvincialTaxReductionData($date)
    {
    ...
    public function getProvincialSurTaxData($date)
    {
    ...
    */
    ...
    public function getFederalEmploymentCreditAmount()
    {
    ...
    public function getFederalEmploymentCreditData($date)
    {
    ...
    */
    ...
    public function getCPPData($date)
    {
    ...
    public function getCPPBasicExemption()
    {
        $data = $this->getCPPData($this->getDate());
    ...
    public function getCPPEmployeeRate()
    {
        $data = $this->getCPPData($this->getDate());
    ...
    public function getCPPEmployeeMaximumContribution()
    {
        $data = $this->getCPPData($this->getDate());
    ...
    */
    ...
    public function getEIData($date)
    {
    ...
    public function getEIEmployeeRate()
    {
        $data = $this->getEIData($this->getDate());
    ...
    public function getEIEmployeeMaximumContribution()
    {
        $data = $this->getEIData($this->getDate());
    ...
    public function getEIEmployerRate()
    {
        $data = $this->getEIData($this->getDate());
    ...
    public function getFederalLowestRate()
    {
    ...
    public function getProvincialLowestRate()
    {
    ...
    public function getProvincialRate($income)
    {
    ...
    public function getProvincialConstant($income)
    {
        $arr = $this->getRateArray($income, 'provincial');
