...
class PayrollDeduction_US_Data extends PayrollDeduction_Base
{
    ...
    public $country_primary_currency = 'USD';
    ...
    public $social_security_options = array(
        20170101 => array( //2017
    ...
    public $federal_ui_options = array(
    ...
    */
    ...
    public function getEICRateArray($income, $type)
    {
    ...
    public function getFederalRate($income)
    {
    ...
    public function getRateArray($income, $type)
    {
        Debug::text('Calculating ' . $type . ' Taxes on: $' . $income, __FILE__, __LINE__, __METHOD__, 10);
    ...
    public function getFederalPreviousRate($income)
    {
        $arr = $this->getRateArray($income, 'federal');
    ...
    public function getFederalRatePreviousIncome($income)
    {
        $arr = $this->getRateArray($income, 'federal');
    ...
    public function getFederalRateIncome($income)
    {
        $arr = $this->getRateArray($income, 'federal');
    ...
    public function getFederalConstant($income)
    {
        $arr = $this->getRateArray($income, 'federal');
    ...
    public function getStateRate($income)
    {
    ...
    public function getStatePreviousRate($income)
    {
        $arr = $this->getRateArray($income, 'state');
    ...
    public function getStateRatePreviousIncome($income)
    {
        $arr = $this->getRateArray($income, 'state');
    ...
    public function getStateRateIncome($income)
    {
        $arr = $this->getRateArray($income, 'state');
    ...
    public function getStateConstant($income)
    {
        $arr = $this->getRateArray($income, 'state');
    ...
    public function getStatePreviousConstant($income)
    {
        $arr = $this->getRateArray($income, 'state');
    ...
    public function getDistrictRate($income)
    {
    ...
    public function getDistrictRatePreviousIncome($income)
    {
        $arr = $this->getRateArray($income, 'district');
    ...
    public function getDistrictRateIncome($income)
    {
        $arr = $this->getRateArray($income, 'district');
    ...
    public function getDistrictConstant($income)
    {
        $arr = $this->getRateArray($income, 'district');
    ...
    public function getSocialSecurityRate($type = 'employee')
    {
        $retarr = $this->getDataFromRateArray($this->getDate(), $this->social_security_options);
        if ($retarr != false) {
    ...
    public function getMedicareAdditionalEmployerThreshold()
    {
        $retarr = $this->getDataFromRateArray($this->getDate(), $this->medicare_options);
    ...
    public function getMedicareAdditionalThresholdRate()
    {
        $retarr = $this->getDataFromRateArray($this->getDate(), $this->medicare_options);
    ...
    public function getFederalUIMaximumContribution()
    {
    ...
    public function getFederalUIMaximumEarnings()
    {
    ...
    public function getFederalUIRate()
    {
        $retarr = $this->getDataFromRateArray($this->getDate(), $this->federal_ui_options);
        if ($retarr != false) {
    ...
    public function getFederalUIMinimumRate()
    {
        $retarr = $this->getDataFromRateArray($this->getDate(), $this->federal_ui_options);
        if ($retarr != false) {
