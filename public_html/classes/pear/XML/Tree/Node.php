...
class XML_Tree_Node
{
    ...
    public function XML_Tree_Node($name, $content = '', $attributes = array(), $lineno = null, $use_cdata_section = null)
    {
    ...
    public function setContent($content, $use_cdata_section = null)
    {
    ...
    public function encodeXmlEntities($xml)
    {
    ...
    public function &addChild($child, $content = '', $attributes = array(), $lineno = null, $use_cdata_section = null)
    {
    ...
    public function registerName($name, $path)
    {
    ...
    public function decodeXmlEntities($xml)
    {
    ...
    public function &get($use_cdata_section = false)
    {
        static $deep = -1;
