...
if (class_exists('PEAR') == false) {
    class PEAR
    {
        ...
        /**
         *   This method call the original raiseError method, call this method can avoid the PHP5.4 STRICT error.
         */
        ...
        {
            $pear = new PEAR();
            return $pear->raiseErrorCore($message, $code, $mode, $options, $userinfo, $error_class, $skipmsg);
        }
         ...
         * @since PHP 4.0.5
         */
        public function &raiseErrorCore($message = null,
                                        $code = null,
                                        $mode = null,
                                        $options = null,
                                        $userinfo = null,
