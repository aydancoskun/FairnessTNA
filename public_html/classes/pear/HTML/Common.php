...
class HTML_Common
{
     ...
     * @throws
     */
    public static function _getLineEnd()
    {
     ...
     * @return  void
     */
    public static function setLineEnd($style)
    {
        switch ($style) {
            case 'win':
                self::$_lineEnd = "\15\12";
     ...
     * @return    string
     */
    public static function _getTab()
    {
        return self::$_tab;
     ...
     * @return    void
     */
    public static function setTab($string)
    {
        self::$_tab = $string;
     ...
     * @throws
     */
    public static function _getAttrKey($attr, $attributes)
    {
     ...
     */
    public static function getAttributes($asString = false)
    {
        if ($asString) {
     ...
     * @access   private
     */
    public static function _getAttrString($attributes)
    {
        $strAttr = '';
     ...
     * @access   public
     */
    public static function updateAttributes($attributes)
    {
     ...
     * @access   private
     */
    public static function _updateAttrArray(&$attr1, $attr2)
    {
        if (!is_array($attr2)) {
            return false;
        }
     ...
     * @access   private
     */
    public static function _parseAttributes($attributes)
    {
        if (is_array($attributes)) {
            $ret = array();
            foreach ($attributes as $key => $value) {
     ...
     * @throws
     */
    public static function _removeAttr($attr, &$attributes)
    {
        $attr = strtolower($attr);
     ...
     * @return    int
     */
    public static function getTabOffset()
    {
     ...
     * @access   public
     */
    public static function setTabOffset($offset)
    {
