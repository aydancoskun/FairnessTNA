...
class HTML_Progress2 extends HTML_Common
{
     ...
     */
    public $_callback_message = false;
     ...
     * @see        _initErrorHandler()
     */
    public $_callback_context = false;
     ...
     * @see        _initErrorHandler()
     */
    public $_callback_errorhandler = false;
     ...
     * @see        _initErrorHandler()
     */
    public $_errorhandler_options = array();
     ...
     * @access     public
     */
    public function HTML_Progress2($errorPrefs = array(),
     ...
     */
    public function __construct($errorPrefs = array(),
                                $orient = HTML_PROGRESS2_BAR_HORIZONTAL, $min = 0, $max = 100,
                                $percentLabel = 'pct1')
    {
     ...
     * @access     private
     */
    public function _initErrorHandler($prefs = array())
    {
     ...
     *             setBorderAttributes()
     */
    public function _updateProgressSize()
    {
        if ($this->cellCount == 0) {
            return;
        }
     ...
     * @see        isBorderPainted()
     */
    public function setBorderPainted($paint)
    {
        if (!is_bool($paint)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$paint',
     ...
     * @see        isIndeterminate()
     */
    public function setIndeterminate($continuous)
    {
     ...
     * @see        getFillWay()
     */
    public function setFillWay($way)
    {
        if (!is_string($way)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$way',
     ...
     * @see        getCellCount()
     */
    public function setCellCount($cells)
    {
        if (!is_int($cells)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$cells',
     ...
     */
    public function setCellCoordinates($xgrid, $ygrid, $coord = array())
    {
        if (!is_int($xgrid)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$xgrid',
     ...
     */
    public function _computeCoordinates($w, $h)
    {
        $coord = array();
     ...
     */
    public function setBorderAttributes($attributes)
    {
     ...
     */
    public function getFrameAttributes($asString = false)
    {
        if (!is_bool($asString)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$asString',
     ...
     */
    public function getLabelAttributes($name, $asString = false)
    {
     ...
     */
    public function setLabelAttributes($name, $attributes)
    {
        if (!isset($this->label[$name])) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'error',
                array('var' => '$name',
     ...
     */
    public function setProgressAttributes($attributes)
    {
     ...
     * @see        getAnimSpeed()
     */
    public function setAnimSpeed($delay)
    {
        if (!is_int($delay)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$delay',
     ...
     */
    public function getProgressAttributes($asString = false)
    {
        if (!is_bool($asString)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$asString',
     ...
     */
    public function getBorderAttributes($asString = false)
    {
        if (!is_bool($asString)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$asString',
     ...
     */
    public function getCellAttributes($asString = false)
    {
        if (!is_bool($asString)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$asString',
     ...
     */
    public function isBorderPainted()
    {
...
JS;
     ...
     */
    public function getPercentComplete($float = true)
    {
        if (!is_bool($float)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
                array('var' => '$float',
     ...
     * @access     private
     */
    public function _getProgressHbar_toHtml()
    {
        $tabs = $this->_getTabs();
        $tab = $this->_getTab();
     ...
     * @access     private
     */
    public function _getProgressVbar_toHtml()
    {
        $tabs = $this->_getTabs();
        $tab = $this->_getTab();
        $way_natural = ($this->fillWay == 'natural');
     ...
     * @access     private
     */
    public function _getProgressPolygonal_toHtml()
    {
        $tabs = $this->_getTabs();
        $tab = $this->_getTab();
        $way_natural = ($this->fillWay == 'natural');
     ...
     * @see        setCellAttributes()
     */
    public function drawCircleSegments($dir = '.', $fileMask = 'c%s.png')
    {
        if (!is_dir($dir)) {
            return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'error',
                array('var' => '$dir',
     ...
     */
    public function setCellAttributes($attributes, $cell = null)
    {
        if (!is_null($cell)) {
            if (!is_int($cell)) {
                return $this->raiseError(HTML_PROGRESS2_ERROR_INVALID_INPUT, 'exception',
     ...
     * @access     private
     */
    public function _getProgressCircle_toHtml()
    {
        $tabs = $this->_getTabs();
        $tab = $this->_getTab();
        $way_natural = ($this->fillWay == 'natural');
     ...
     */
    public function _refreshDisplay($value)
    {
        static $determinate;
