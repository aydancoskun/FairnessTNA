 ...
 * @version    CVS: $Id: Error.php,v 1.1 2005/06/12 21:00:25 farell Exp $
...
class HTML_Progress2_Error extends PEAR_Error
{
     ...
     * @access     public
     */
    public function HTML_Progress2_Error($message = null,
                                         $code = null,
     ...
     * @access     private
     */
    public function _display($userinfo)
    {
     ...
     * @access     private
     */
    public function _handleError($code, $level)
    {
        if ($level == 'exception') {
     ...
     * @access     private
     */
    public function _msgCallback($code, $userinfo)
    {
