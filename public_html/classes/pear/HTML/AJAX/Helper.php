...
class HTML_AJAX_Helper
{
     ...
     * @var    array
     */
    public $jsLibraries = array('Util', 'Main', 'Request', 'HttpClient', 'Dispatcher', 'Behavior', 'Loading', 'JSON', 'iframe');
     ...
     */
    public $combineJsIncludes = false;
     ...
     * @return string
     */
    public function encloseInScript($input)
    {
     ...
     */
    public function loadingMessage($body, $class = 'HTML_AJAX_Loading',
     ...
     */
    public function updateElement($id, $update, $type, $enclose = false)
    {
        if (is_array($update)) {
            $updateStr = "";
            $comma = '';
