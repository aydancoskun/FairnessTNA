...
class HTML_AJAX_Server
{
     ...
     * @var array
     */
    public $javascriptLibraries = array(
        'all' => 'HTML_AJAX.js',
     ...
     */
    public $javascriptLibraryPaths = array();
     ...
     */
    public function HTML_AJAX_Server($serverUrl = false)
    {
     ...
     * @access  private
     */
    public function _cleanIdentifier($input)
    {
    ...
    public function generateClient()
    {
        ...
        if (count($fileList) > 0) {
            ...
            elseif (isset($jsETag) && isset($stubETag)) {
     ...
     * @return  string
     */
    public function clientJsLocation()
    {
     ...
     * @access private
     */
    public function _init($className)
    {
     ...
     */
    public function _callCacheRule($rule, $payload)
    {
     ...
     * @access  private
     */
    public function _compareEtags($serverETag)
    {
     ...
     * @access  private
     */
    public function _sendCacheHeaders($etag, $notModified)
    {
     ...
     */
    public function setSerializer($type)
    {
     ...
     */
    public function registerJSLibrary($libraryName, $fileName, $path = false)
    {
     ...
     */
    public function registerInitObject(&$instance)
    {
     ...
     */
    public function registerClass(&$instance, $exportedName = false, $exportedMethods = false)
    {
     ...
     * @return  void
     */
    public function setClientJsLocation($location)
    {
     ...
     * @return  void
     */
    public function setJavascriptLibraryPath($library, $path)
    {
     ...
     * @return  void
     */
    public function setJavascriptLibraryPaths($paths)
    {
        if (is_array($paths)) {
     ...
     * @access  private
     */
    public function _cacheRuleFile($files)
    {
        $signature = "";
     ...
     * @access  private
     */
    public function _cacheRuleApi($classes)
    {
        $signature = "";
     ...
     * @access  private
     */
    public function _cacheRuleContent($content)
    {
        return md5($content);
    }
}
