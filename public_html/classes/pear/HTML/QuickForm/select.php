...
class HTML_QuickForm_select extends HTML_QuickForm_element
{
     ...
     * @throws    PEAR_Error
     */
    public static function load(&$options, $param1 = null, $param2 = null, $param3 = null, $param4 = null)
    {
        switch (true) {
     ...
     * @throws    PEAR_Error
     */
    public static function loadArray($arr, $values = null)
    {
        if (!is_array($arr)) {
     ...
     * @return    void
     */
    public static function setSelected($values)
    {
     ...
     * @return    void
     */
    public static function addOption($text, $value, $attributes = null)
    {
        if (null === $attributes) {
     ...
     * @throws    PEAR_Error
     */
    public static function loadDbResult(&$result, $textCol = null, $valueCol = null, $values = null)
    {
     ...
     * @throws    PEAR_Error
     */
    public static function loadQuery(&$conn, $sql, $textCol = null, $valueCol = null, $values = null)
    {
        if (is_string($conn)) {
            require_once('DB.php');
