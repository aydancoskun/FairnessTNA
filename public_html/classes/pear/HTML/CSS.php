...
class HTML_CSS extends HTML_Common
{
     ...
     * @access     public
     */
    public function raiseError($code, $level, $params)
    {
     ...
     * @access   public
     */
    public function createGroup($selectors, $identifier = null)
    {
        if ($identifier === null) {
            $this->_groupCount++;
     ...
     * @access   public
     */
    public function setGroupStyle($group, $property, $value)
    {
     ...
     * @access   public
     */
    public function setStyle($element, $property, $value)
    {
...
/**
     ...
     * @access     private
     */
    public function _msgCallback(&$stack, $err)
    {
