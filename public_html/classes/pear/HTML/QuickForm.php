...
class HTML_QuickForm extends HTML_Common
{
     ...
     * @access   public
     */
    public function HTML_QuickForm($formName = '', $method = 'post', $action = '', $target = '_self', $attributes = null, $trackSubmit = false)
    {
...
/**
     ...
     * @return    void
     */
    public function setElementError($element, $message)
    {
