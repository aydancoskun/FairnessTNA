...
class Payment_Process_LinkPoint extends Payment_Process_Common
{
     ...
     * @return void
     */
    public function Payment_Process_LinkPoint($options = false)
    {
...
class Payment_Process_Result_LinkPoint extends Payment_Process_Result
{
    ...
    public $_cvvCodeMap = array('M' => PAYMENT_PROCESS_CVV_MATCH,
    ...
    public $_fieldMap = array('r_approved' => 'code',
        'r_error' => 'message',
        'r_code' => 'approvalCode',
        'r_ordernum' => 'transactionId'
    );

    public function Payment_Process_Response_LinkPoint($rawResponse)
    {
...
class Payment_Processor_LinkPoint_XML_Parser extends XML_Parser
{
     ...
     * @see XML_Parser
     */
    public function Payment_Processor_LinkPoint_XML_Parser()
    {
        $this->XML_Parser();
    }
     ...
     * @return void
     */
    public function defaultHandler($xp, $data)
    {
