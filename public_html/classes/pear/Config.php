...
class Config
{
     ...
     */
    public function registerConfigType($configType, $configInfo = false)
    {
     ...
     * @return   bool
     */
    public function isConfigTypeRegistered($configType)
    {
     ...
     */
    public function setRoot(&$rootContainer)
    {
     ...
     */
    public function &parseConfig($datasrc, $configType, $options = array())
    {
     ...
     */
    public function writeConfig($datasrc = null, $configType = null, $options = array())
    {
        if (empty($datasrc)) {
