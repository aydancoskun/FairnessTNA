...
class Validate_US
{
     ...
     * @return bool
     */
    public function ssn($ssn, $high_groups = null)
    {
     ...
     * @return array
     */
    public function ssnGetHighGroups($uri = 'http://www.ssa.gov/employer/highgroup.txt',
                                     $is_text = false)
    {
        /**
     ...
     */
    public function ssnCheck($area, $group, $serial, $high_groups)
    {
        if (is_array($area)) {
            extract($area);
        }
     ...
     * @return int
     */
    public function ssnGroupRange($groupNumber)
    {
     ...
     * @static
     */
    public function postalCodeByRegion($postalCode, $region)
    {
        /*
     ...
     * @access public
     */
    public function phoneNumber($number, $requireAreaCode = true)
    {
