...
/**
     ...
     * @access   public
     */
    public function Validate_Finance_IBAN($iban = '')
    {
...
/**
     ...
     * @access  private
     */
    public function _getCountrycodeCountryname()
    {
     ...
     */
    public function validate($arg = null)
    {
     ...
     * @access  private
     */
    public function _getCountrycodeIBANLength()
    {
        static $_iban_countrycode_length;
        if (!isset($_iban_countrycode_length)) {
     ...
     * @access  private
     */
    public function _getCountrycodeRegex()
    {
        static $_iban_countrycode_regex;
        if (!isset($_iban_countrycode_regex)) {
     ...
     * @access  private
     */
    public function _getCountrycodeBankcode()
    {
     ...
     * @access  private
     */
    public function _getCountrycodeBankaccount()
    {
