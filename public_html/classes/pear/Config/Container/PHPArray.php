...
class Config_Container_PHPArray
{
     ...
     * @var  array
     */
    public $options = array('name' => 'conf',
        'useAttr' => true,
     ...
     */
    public function Config_Container_PHPArray($options = array())
    {
     ...
     * @return void
     */
    public function _parseArray($array, &$container)
    {
     ...
     * @return string
     */
    public function writeDatasrc($datasrc, &$obj)
    {
        $fp = @fopen($datasrc, 'w');
        if ($fp) {
     ...
     * @return string
     */
    public function _getParentString(&$obj)
    {
        $string = '';
        if (!$obj->isRoot()) {
