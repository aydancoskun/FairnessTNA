...
class Image_Color
{
     ...
     *                  class.
     */
    public static function mixColors($col1 = false, $col2 = false)
    {
        if ($col1) {
            self::_setColors($col1, $col2);
        }

        // after finding the average, it will be a float. add 0.5 and then
        // cast to an integer to properly round it to an integer.
        $color3[0] = (int)(((self::$color1[0] + self::$color2[0]) / 2) + 0.5);
        $color3[1] = (int)(((self::$color1[1] + self::$color2[1]) / 2) + 0.5);
        $color3[2] = (int)(((self::$color1[2] + self::$color2[2]) / 2) + 0.5);
     ...
     * @author  Jason Lotito <jason@lehighweb.com>
     */
    public static function _setColors($col1, $col2)
    {
        if ($col1) {
     ...
     * @author  Jason Lotito <jason@lehighweb.com>
     */
    public static function setWebSafe($bool = true)
    {
        self::$_websafeb = (boolean)$bool;
    }
     ...
     * @author  Jason Lotito <jason@lehighweb.com>
     */
    public static function setColors($col1, $col2)
    {
        self::_setColors($col1, $col2);
    }
     ...
     */
    public static function getRange($degrees = 2)
    {
        if ($degrees == 0) {
            $degrees = 1;
        }
        ...
        $red_steps = (self::$color2[0] - self::$color1[0]) / $degrees;
        $green_steps = (self::$color2[1] - self::$color1[1]) / $degrees;
        $blue_steps = (self::$color2[2] - self::$color1[2]) / $degrees;
     ...
     */
    public static function changeLightness($degree = 10)
    {
        $color1 = self::$color1;
        $color2 = self::$color2;
     ...
     * @author  Jason Lotito <jason@lehighweb.com>
     */
    public static function getTextColor($color, $light = '#FFFFFF', $dark = '#000000')
    {
     ...
     * @see     rgb2hex().
     */
    public static function _returnColor($color)
    {
     ...
     * @static
     */
    public static function percentageColor2RGB($color)
    {
        // remove spaces
        $color = str_replace(' ', '', $color);
