...
// the image along with the barcode text and display it to the beholder.
        ...
        public function Image_Barcode_code128()
    {
        $this->code[0] = "212222";  // " "
        $this->code[1] = "222122";  // "!"
...
/**
     ...
     *
     */
    public function draw($text, $imgtype = 'png', $type = 'int25', $send_headers = true, $print_text = true, $height = null)
    {
