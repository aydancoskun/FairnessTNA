...
class GovernmentForms_US_940 extends GovernmentForms_US
{
    ...
    public function filterL2($value)
    {
        if ($this->l11 > 0) {
            return true;
        }
    ...
    public function filterL15($value)
    {
        if ($this->l15 > 0) {
            return $value;
        }
    ...
    public function filterL16($value)
    {
    ...
    public function calcL6($value, $schema)
    {
    ...
    public function calcL8($value, $schema)
    {
    ...
    public function calcL9($value, $schema)
    {
        //Taxable FUTA wages
    ...
    public function calcL14($value, $schema)
    {
        //Balance Due
    ...
    public function calcL15($value, $schema)
    {
        //Balance Due
    ...
    public function calcL17($value, $schema)
    {
